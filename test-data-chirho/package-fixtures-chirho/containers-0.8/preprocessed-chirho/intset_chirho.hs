{-# LINE 1 ".haskelujah-packages-chirho/containers-0.8/src/Data/IntSet/Internal.hs" #-}
...
highestBitSet x = 64 - 1 - countLeadingZeros x
...
takeWhileAntitoneBits prefix predicate bitmap =
  ...
  -- min (log2 64 + 1) (popcount bitmap) predicate calls.
  let next d h (n',b') =
