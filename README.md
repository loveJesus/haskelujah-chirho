...
| Hackage Packages | **56 compile** including **transformers** + **mtl** + **parsec** + **stm** + **vector** + **hashable** + **primitive** + **scientific** + **dlist** + **split** + **safe** |
...
| Hackage packages | cabal-install | `haskelujah install` — **56 packages compile** (transformers, mtl, parsec, stm, vector, hashable, dlist, split, safe) |
