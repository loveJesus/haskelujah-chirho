...
| Hackage Packages | **33 compile** including **transformers** + **mtl** + **parsec** + **deepseq** + **vector** + **hashable** + **primitive** + **ansi-terminal** |
...
| Hackage packages | cabal-install | `haskelujah install` — **27+ packages compile** (transformers, mtl, parsec, colour, HUnit) |
