...
| Hackage Packages | **71 compile** including **transformers** + **mtl** + **parsec** + **stm** + **comonad** + **contravariant** + **distributive** + **vector** + **hashable** + **dlist** |
...
| Hackage packages | cabal-install | `haskelujah install` — **71 packages compile** (transformers, mtl, parsec, stm, comonad, contravariant, distributive, vector) |
