...
| Hackage Packages | **68 compile** including **transformers** + **mtl** + **parsec** + **stm** + **comonad** + **contravariant** + **distributive** + **vector** + **hashable** + **dlist** |
...
| Hackage packages | cabal-install | `haskelujah install` — **68 packages compile** (transformers, mtl, parsec, stm, comonad, contravariant, distributive, vector) |
