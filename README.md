...
| Hackage Packages | **132 verified** (strict 45s timeout) including **parsec** (25 modules) + **mtl** (24 modules) + **QuickCheck** (18 modules) + **cereal** + **hashable** + **scientific** + **case-insensitive** + **strict** |
...
| Hackage packages | cabal-install | `haskelujah install` — **132 packages verified** (parsec, mtl, QuickCheck, cereal, hashable, scientific, case-insensitive, strict) |
