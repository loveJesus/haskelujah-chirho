...
| Hackage Packages | **139 verified** (strict 50s timeout) including **parsec** (25 modules) + **mtl** (24 modules) + **QuickCheck** (18 modules) + **binary** + **cereal** + **hashable** + **text-short** + **multimap** |
...
| Hackage packages | cabal-install | `haskelujah install` — **139 packages verified** (parsec, mtl, QuickCheck, binary, cereal, hashable, text-short, multimap) |
