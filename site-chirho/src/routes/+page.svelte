...
<script lang="ts">
	...
	const statsChirho = [
		...
		{ labelChirho: 'Hackage Packages', valueChirho: '26', detailChirho: 'transformers + mtl + parsec + deepseq + vector + colour + data-fix + 19 more' }
	];
	...
	const featuresChirho = [
		...
		},
		{
			...
			descriptionChirho:
				'Install Hackage packages with one command. Reads .cabal files, resolves dependencies, compiles multi-module projects. 26 packages compile today, cross-package resolution built in.',
			iconChirho: '📦',
			plannedChirho: false
		},
		{
		...
		<div class="hero-content-chirho">
			...
			<div class="hero-proof-chirho">
				...
				<div class="hero-proof-card-chirho">
					...
					<strong>26 packages compile</strong>
			...
			<div class="feature-grid-chirho">
				...
				<div class="feature-card-chirho">
					...
					<div class="feature-text-chirho">
						...
						<p><code>haskelujah install aeson</code> fetches from Hackage. <strong>26 packages compile</strong> including transformers, mtl, deepseq, vector, exceptions. Plus 15 built-in stdlib modules (JSON, Test, Args, HTTP, Text, Process, Time, File, Prelude, Map, Set, Pretty, Random, Concurrent, Debug) — no install needed.</p>
					</div>
				</div>
				<div class="feature-card-chirho">
		...
		<div class="section-inner-chirho">
			...
			<div class="roadmap-grid-chirho">
				...
				<div class="roadmap-item-chirho">
					...
					<p>26 packages compile today (transformers + mtl + deepseq + vector + exceptions). Next: aeson, lens, containers, megaparsec, QuickCheck.</p>
				</div>
				<div class="roadmap-item-chirho">
					<h3>Test Runner</h3>
