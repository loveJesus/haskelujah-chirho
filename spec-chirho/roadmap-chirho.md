...
- `rhasky-span-chirho` provides file IDs, byte offsets, and span types
- `rhasky-diagnostics-chirho` uses real spans, supports error codes and labeled secondary spans
- golden-test and property-test infrastructure exists in `rhasky-test-harness-chirho`
...
- `rhasky-base-chirho` covers enough of Prelude and common modules for real packages
