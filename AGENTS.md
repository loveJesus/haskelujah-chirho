...
- Phase 3 done so far: GADTs, RankNTypes, ScopedTypeVariables, RecordWildCards, ViewPatterns, PatternSynonyms, strict data fields, DerivingVia, NamedFieldPuns, MultiWayIf ([spec-chirho/phase3-progress-chirho.md](spec-chirho/phase3-progress-chirho.md))
