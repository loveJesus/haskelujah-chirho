...
//!
//! This module provides the translation from rhasky's AST types
...
/// Convert a rhasky AST type to a TH type.
...
/// Convert a rhasky AST type variable to a TH type variable binder.
...
/// Convert a rhasky constructor declaration to a TH constructor.
