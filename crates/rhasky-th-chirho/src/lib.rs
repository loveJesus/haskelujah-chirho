...
//! # Template Haskell support for Rhasky
//!
//! This crate provides:
...
//! - Splice evaluation and conversion back to rhasky AST
//!
//! The TH types are deliberately separate from `rhasky-ast-chirho` types because
