...
//!    `.T` driver files, run matching `.hs` files through Rhasky, track pass rate.
//!
...
/// Run a single GHC test case through the Rhasky pipeline.
pub fn run_ghc_test_chirho(
    test_chirho: &GhcTestCaseChirho,
) -> GhcTestResultChirho {
    let mut source_map_chirho = rhasky_span_chirho::SourceMapChirho::new_chirho();

    match test_chirho.kind_chirho {
        GhcTestKindChirho::CompileChirho => {
            // Should compile without errors.
            match rhasky_driver_chirho::compile_source_chirho(
        ...
        GhcTestKindChirho::CompileAndRunChirho => {
            ...
            match rhasky_driver_chirho::eval_source_with_machine_chirho(
                &test_chirho.source_chirho,
                &mut source_map_chirho,
                &test_chirho.name_chirho,
                None,
