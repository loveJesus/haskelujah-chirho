...
//!
//! Provides infrastructure for comparing Rhasky behavior against GHC
...
//! - Whether Rhasky agrees with GHC
//!
...
pub struct DiffTestResultChirho {
    ...
    /// Rhasky actual outcome.
    pub rhasky_outcome_chirho: CompileOutcomeChirho,
    /// Whether Rhasky agrees with GHC.
...
impl DiffSuiteResultChirho {
    /// Count of tests where Rhasky agrees with GHC.
    ...
    pub fn summary_table_chirho(&self) -> String {
        ...
        lines_chirho.push(format!(
            "{:<30} {:<10} {:<20} {:<20} {:<6}",
            "Test", "Category", "GHC", "Rhasky", "Match"
        ));
        ...
        for r_chirho in &self.results_chirho {
            lines_chirho.push(format!(
                ...
                format_outcome_chirho(&r_chirho.rhasky_outcome_chirho),
    ...
    F: Fn(&str) -> CompileOutcomeChirho,
{
    ...
    let results_chirho: Vec<DiffTestResultChirho> = cases_chirho
        .iter()
        .map(|case_chirho| {
            let rhasky_chirho = eval_fn_chirho(case_chirho.source_chirho);
            ...
            DiffTestResultChirho {
                ...
                rhasky_outcome_chirho: rhasky_chirho,
                agrees_chirho,
            }
        })
        .collect();
...
fn outcomes_agree_chirho(
    ...
    rhasky_chirho: &CompileOutcomeChirho,
) -> bool {
    match (ghc_chirho, rhasky_chirho) {
        ...
        let suite_chirho = DiffSuiteResultChirho {
            results_chirho: vec![
                DiffTestResultChirho {
                    ...
                    rhasky_outcome_chirho: CompileOutcomeChirho::SuccessIntChirho(1),
                    agrees_chirho: true,
                },
                DiffTestResultChirho {
                    name_chirho: "b".into(),
                    ...
                    rhasky_outcome_chirho: CompileOutcomeChirho::SuccessIntChirho(99),
                    agrees_chirho: false,
                },
            ],
        };
