...
use haskeluya_ast_chirho::expr_chirho::{ExprChirho, MatchArmChirho, RhsChirho, StmtChirho};
...
use haskeluya_ast_chirho::ty_chirho::{ConstraintChirho as AstConstraintChirho, TypeChirho};
    ...
    pub fn infer_expr_chirho(
        ...
        match expr_chirho {
            ...
            ExprChirho::VarChirho(name_chirho) => {
                ...
                match scheme_opt_chirho {
                    ...
                    None => {
                        ...
                        let max_dist_chirho = haskeluya_diagnostics_chirho::suggest_chirho::default_max_distance_chirho(text_chirho.len());
                        let suggestions_chirho = haskeluya_diagnostics_chirho::suggest_chirho::suggest_similar_names_chirho(
                            text_chirho,
                            candidates_chirho.into_iter(),
                            max_dist_chirho,
                            3,
                        );
                        if let Some(note_chirho) = haskeluya_diagnostics_chirho::suggest_chirho::format_did_you_mean_chirho(&suggestions_chirho) {
            ...
            ExprChirho::LetChirho {
                ...
                let mut local_sigs_chirho: HashMap<String, haskeluya_ast_chirho::ty_chirho::TypeChirho> = HashMap::new();
                for bind_chirho in binds_chirho {
                    if let haskeluya_ast_chirho::expr_chirho::LocalBindChirho::TypeSigChirho {
                ...
                for bind_chirho in binds_chirho {
                    match bind_chirho {
                        ...
                        haskeluya_ast_chirho::expr_chirho::LocalBindChirho::TypeSigChirho { .. } => {
            ...
            ExprChirho::CaseChirho {
                ...
                for alt_chirho in alts_chirho {
                    ...
                    let mut wb_sigs_chirho: HashMap<String, haskeluya_ast_chirho::ty_chirho::TypeChirho> = HashMap::new();
...
mod tests_chirho {
    ...
    use haskeluya_ast_chirho::expr_chirho::AltChirho;
    use haskeluya_ast_chirho::module_chirho::ModuleChirho;
    ...
    fn infer_user_class_decl_chirho() {
        use haskeluya_ast_chirho::decl_chirho::ClassMethodChirho;
    ...
    fn infer_user_class_with_superclass_chirho() {
        use haskeluya_ast_chirho::decl_chirho::ClassMethodChirho;
        use haskeluya_ast_chirho::ty_chirho::ConstraintChirho as AstConstraintChirho;
