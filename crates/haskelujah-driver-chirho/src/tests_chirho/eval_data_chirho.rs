...
";
    ...
    match &result_chirho {
        ...
        Err(e_chirho) => panic!(
            "newtype record field accessor should evaluate: {}",
            e_chirho
        ),
    }
}
...
";
    ...
    match &result_chirho {
        Ok(val_chirho) => {
            assert_eq!(
                *val_chirho,
                haskelujah_runtime_chirho::ValueChirho::IntChirho(119)
            );
        }
...
";
    ...
    assert_eq!(
        val_chirho,
        haskelujah_runtime_chirho::ValueChirho::IntChirho(123)
    );
}
...
";
    ...
    let has_sb_chirho = result_chirho
        .core_chirho
        .bindings_chirho
        .iter()
        .any(|b_chirho| {
...
";
    ...
    match &result_chirho {
        ...
        Err(e_chirho) => panic!(
            "RecordWildCards partial pattern should evaluate: {}",
            e_chirho
        ),
    }
}
...
";
    ...
    match &result_chirho {
        ...
        Err(e_chirho) => panic!(
            "RecordWildCards partial expression should evaluate: {}",
            e_chirho
        ),
    }
}
...
";
    ...
    let cst_chirho =
        haskelujah_parser_chirho::cst_parser_chirho::parse_to_cst_chirho(src_chirho, fid_chirho);
    let module_chirho =
        haskelujah_parser_chirho::lower_chirho::lower_module_chirho(&cst_chirho, fid_chirho);
            ...
            if name_chirho.text_chirho() == "f" {
                for m_chirho in matches_chirho {
                    if let RhsChirho::UnguardedChirho(expr_chirho) = &m_chirho.rhs_chirho {
                        if let ExprChirho::RecordConChirho {
                            has_wildcard_chirho,
                            ..
                        } = expr_chirho
                        {
    ...
    assert!(
        found_wildcard_chirho,
        "MkPoint{{..}} should parse as RecordConChirho with has_wildcard_chirho=true"
    );
}
...
"#;
    ...
    } = class_decl_chirho
    {
        ...
        assert_eq!(associated_tfs_chirho[0].name_chirho.text_chirho(), "Elem");
    }
}
...
";
    ...
    match &result_chirho {
        ...
        Err(e_chirho) => panic!(
            "polymorphic return with IO default should evaluate: {}",
            e_chirho
        ),
    }
}
...
";
    ...
    assert!(
        result_chirho.is_ok(),
        "Monad m => a -> m a with return should compile: {:?}",
        result_chirho.err()
    );
}
...
";
    ...
    assert!(
        result_chirho.is_ok(),
        "Monad m => m Int with return should compile: {:?}",
        result_chirho.err()
    );
}
...
";
    ...
    assert!(
        result_chirho.is_ok(),
        "where-clause capturing outer var should compile: {:?}",
        result_chirho.err()
    );
}
...
";
    ...
    assert!(
        result_chirho.is_ok(),
        "let-polymorphism should generalize f: {:?}",
        result_chirho.err()
    );
}
...
";
    ...
    assert!(
        result_chirho.is_ok(),
        "let-polymorphism for wrap should work: {:?}",
        result_chirho.err()
    );
}
...
";
    ...
    assert!(
        result_chirho.is_ok(),
        "multiple polymorphic where-bindings: {:?}",
        result_chirho.err()
    );
}
