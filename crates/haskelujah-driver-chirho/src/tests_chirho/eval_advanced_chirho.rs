...
fn eval_recursive_sum_chirho() {
    ...
    match &result_chirho {
        Ok(val_chirho) => {
            assert_eq!(
                *val_chirho,
                haskelujah_runtime_chirho::ValueChirho::IntChirho(55)
            );
        }
        Err(e_chirho) => {
...
fn eval_where_recursive_chirho() {
    ...
    match &result_chirho {
        Ok(val_chirho) => {
            assert_eq!(
                *val_chirho,
                haskelujah_runtime_chirho::ValueChirho::IntChirho(24)
            );
        }
        Err(e_chirho) => {
...
";
    ...
    assert_eq!(
        result_chirho.1.io_output_chirho, "item\nitem\nitem\ndone\n",
...
fn eval_right_section_chirho() {
    ...
    match result_chirho {
        Ok(val_chirho) => assert_eq!(
            val_chirho,
            haskelujah_runtime_chirho::ValueChirho::IntChirho(18)
        ),
...
";
    ...
    match result_chirho {
        Ok(val_chirho) => assert_eq!(
            val_chirho,
            haskelujah_runtime_chirho::ValueChirho::IntChirho(21)
        ),
...
fn eval_throw_uncaught_chirho() {
    ...
    assert!(
        ...
        "uncaught throw should produce error"
    );
    let msg_chirho = result_chirho.unwrap_err();
    assert!(
        msg_chirho.contains("uncaught"),
        "error message should contain 'uncaught': {}",
        msg_chirho
    );
}
...
"#;
    let (_val_chirho, m_chirho) = eval_source_with_step_limit_chirho(
        src_chirho,
        &mut sm_chirho,
        "TestChirho.hs",
        None,
...
";
    ...
    assert_eq!(
        result_chirho,
        haskelujah_runtime_chirho::ValueChirho::IntChirho(35)
    );
}
...
";
    ...
    assert_eq!(
        result_chirho,
        haskelujah_runtime_chirho::ValueChirho::IntChirho(3628800)
    );
}
...
fn eval_prelude_import_implicit_chirho() {
    ...
    let result_chirho =
        eval_source_with_machine_chirho(src_chirho, &mut sm_chirho, "Test.hs", None)
...
fn eval_deepseq_basic_chirho() {
    ...
    let src_chirho = "module Test where\nmain = deepseq 1 42\n";
    let result_chirho =
        eval_source_chirho(src_chirho, &mut sm_chirho, "Test.hs", None).expect("deepseq basic");
    assert_eq!(
        result_chirho,
        haskelujah_runtime_chirho::ValueChirho::IntChirho(42)
    );
...
fn eval_deepseq_list_chirho() {
    ...
    let result_chirho =
        eval_source_chirho(src_chirho, &mut sm_chirho, "Test.hs", None).expect("deepseq list");
    assert_eq!(
        result_chirho,
        haskelujah_runtime_chirho::ValueChirho::IntChirho(99)
    );
...
fn eval_force_basic_chirho() {
    ...
    let src_chirho = "module Test where\nmain = force 42\n";
    let result_chirho =
        eval_source_chirho(src_chirho, &mut sm_chirho, "Test.hs", None).expect("force basic");
    assert_eq!(
        result_chirho,
        haskelujah_runtime_chirho::ValueChirho::IntChirho(42)
    );
...
fn eval_evaluate_basic_chirho() {
    ...
    let src_chirho = "module Test where\nmain = evaluate (2 + 3)\n";
    let result_chirho =
        eval_source_chirho(src_chirho, &mut sm_chirho, "Test.hs", None).expect("evaluate basic");
    assert_eq!(
        result_chirho,
        haskelujah_runtime_chirho::ValueChirho::IntChirho(5)
    );
...
"#;
    ...
    assert!(
        warnings_chirho
            .iter()
            .any(|w_chirho| w_chirho.contains("orphan instance")),
...
main = 42
"#;
    let warnings_chirho = frontend_warnings_chirho(src_chirho, &mut sm_chirho, "LocalChirho.hs")
        .expect("frontend should succeed");
    assert!(
        !warnings_chirho
            .iter()
...
fn inline_pragma_parse_chirho() {
    ...
    let src_chirho =
        "module Main where\n{-# INLINE double #-}\ndouble x = x + x\nmain = double 21\n";
    let result_chirho =
        eval_source_chirho(src_chirho, &mut sm_chirho, "InlineTest.hs", None).unwrap();
...
fn noinline_pragma_parse_chirho() {
    ...
    let result_chirho =
        eval_source_chirho(src_chirho, &mut sm_chirho, "NoInlineTest.hs", None).unwrap();
...
fn inlinable_pragma_parse_chirho() {
    ...
    let src_chirho =
        "module Main where\n{-# INLINABLE triple #-}\ntriple x = x + x + x\nmain = triple 10\n";
    let result_chirho =
        eval_source_chirho(src_chirho, &mut sm_chirho, "InlinableTest.hs", None).unwrap();
...
fn inline_pragma_multiple_chirho() {
    ...
    let src_chirho = "module Main where\n{-# INLINE add1 #-}\n{-# NOINLINE mul2 #-}\nadd1 x = x + 1\nmul2 x = x * 2\nmain = add1 (mul2 10)\n";
    let result_chirho =
        eval_source_chirho(src_chirho, &mut sm_chirho, "MultiPragmaTest.hs", None).unwrap();
...
fn specialize_pragma_basic_chirho() {
    ...
    let result_chirho =
        eval_source_chirho(src_chirho, &mut sm_chirho, "SpecTest.hs", None).unwrap();
    assert_eq!(result_chirho, ValueChirho::IntChirho(42));
}
...
fn specialize_pragma_creates_binding_chirho() {
    ...
    let src_chirho = "module Main where\n{-# SPECIALIZE double :: Int -> Int #-}\ndouble x = x + x\nmain = double 21\n";
    let result_chirho =
        compile_source_chirho(src_chirho, &mut sm_chirho, "SpecBindTest.hs").unwrap();
    ...
    assert!(
        spec_binding_chirho.is_some(),
        "Expected $spec_double binding in Core"
    );
}
...
fn specialise_british_spelling_eval_chirho() {
    ...
    let result_chirho =
        eval_source_chirho(src_chirho, &mut sm_chirho, "SpecialiseTest.hs", None).unwrap();
    assert_eq!(result_chirho, ValueChirho::IntChirho(42));
}
...
fn specialize_multiple_types_eval_chirho() {
    ...
    let result_chirho =
        eval_source_chirho(src_chirho, &mut sm_chirho, "MultiSpecTest.hs", None).unwrap();
    assert_eq!(result_chirho, ValueChirho::IntChirho(42));
}
...
";
    let result_chirho =
        eval_source_chirho(src_chirho, &mut sm_chirho, "DefaultSigTest.hs", None).unwrap();
    assert_eq!(result_chirho, ValueChirho::IntChirho(42));
}
...
";
    let result_chirho =
        eval_source_chirho(src_chirho, &mut sm_chirho, "DefaultSigOverride.hs", None).unwrap();
    assert_eq!(result_chirho, ValueChirho::IntChirho(42));
}
...
";
    let result_chirho =
        compile_source_chirho(src_chirho, &mut sm_chirho, "DefaultSigAST.hs").unwrap();
...
#[test]
fn gnd_missing_underlying_class_method_slot_errors_by_name_chirho() {
    use crate::eval_source_chirho;
    let mut sm_chirho = SourceMapChirho::new_chirho();
    let src_chirho = "\
...
instance Needs Int => Needs Age
main = needed (MkAge 1)
";
    let result_chirho =
        eval_source_chirho(src_chirho, &mut sm_chirho, "GndMissingMethodSlot.hs", None);
    let err_chirho =
    ...
    assert!(
        !msg_chirho.contains("literal 0"),
        "GND missing underlying method must not become a literal-0 slot failure: {msg_chirho}"
    );
}
...
";
    let result_chirho =
        eval_source_with_machine_chirho(src_chirho, &mut sm_chirho, "ShareBug.hs", None);
    match result_chirho {
...
";
    let result_chirho =
        eval_source_with_machine_chirho(src_chirho, &mut sm_chirho, "ShareBug2.hs", None);
    match result_chirho {
        Ok((_val_chirho, machine_chirho)) => {
            let output_chirho = &machine_chirho.io_output_chirho;
...
";
    let result_chirho =
        eval_source_with_machine_chirho(src_chirho, &mut sm_chirho, "ShareBug3.hs", None);
    match result_chirho {
        Ok((_val_chirho, machine_chirho)) => {
            let output_chirho = &machine_chirho.io_output_chirho;
...
";
    let result_chirho =
        eval_source_with_machine_chirho(src_chirho, &mut sm_chirho, "ShareBug4.hs", None);
    match result_chirho {
        Ok((_val_chirho, machine_chirho)) => {
            let output_chirho = &machine_chirho.io_output_chirho;
            assert_eq!(output_chirho, "3\n[1,2]\n");
...
";
    let result_chirho =
        eval_source_with_machine_chirho(src_chirho, &mut sm_chirho, "ShareBug5.hs", None);
    match result_chirho {
        Ok((_val_chirho, machine_chirho)) => {
            let output_chirho = &machine_chirho.io_output_chirho;
...
";
    let result_chirho =
        eval_source_with_machine_chirho(src_chirho, &mut sm_chirho, "ShareBug6.hs", None);
    match result_chirho {
        Ok((_val_chirho, machine_chirho)) => {
            let output_chirho = &machine_chirho.io_output_chirho;
            assert_eq!(output_chirho, "3\n7\n");
...
";
    let result_chirho =
        eval_source_with_machine_chirho(src_chirho, &mut sm_chirho, "ShareBug8.hs", None);
    match result_chirho {
        Ok((_val_chirho, machine_chirho)) => {
            let output_chirho = &machine_chirho.io_output_chirho;
            assert_eq!(output_chirho, "3\n42\n");
...
";
    let result_chirho =
        eval_source_with_machine_chirho(src_chirho, &mut sm_chirho, "ShareBug9.hs", None);
    match result_chirho {
        Ok((_val_chirho, machine_chirho)) => {
            let output_chirho = &machine_chirho.io_output_chirho;
            assert_eq!(output_chirho, "3\n2\n");
...
";
    let result_chirho =
        eval_source_with_machine_chirho(src_chirho, &mut sm_chirho, "ShareBugA.hs", None);
    match result_chirho {
        Ok((_val_chirho, machine_chirho)) => {
            let output_chirho = &machine_chirho.io_output_chirho;
            assert_eq!(output_chirho, "3\n[4,5,6]\n");
...
";
    let result_chirho =
        eval_source_with_machine_chirho(src_chirho, &mut sm_chirho, "ShareBugB.hs", None);
    match result_chirho {
        Ok((_val_chirho, machine_chirho)) => {
            let output_chirho = &machine_chirho.io_output_chirho;
...
";
    let result_chirho =
        eval_source_with_machine_chirho(src_chirho, &mut sm_chirho, "ShareBugF.hs", None);
    match result_chirho {
        Ok((_val_chirho, machine_chirho)) => {
            let output_chirho = &machine_chirho.io_output_chirho;
...
";
    let result_chirho =
        eval_source_with_machine_chirho(src_chirho, &mut sm_chirho, "ShareBugG.hs", None);
    match result_chirho {
        Ok((_val_chirho, machine_chirho)) => {
            let output_chirho = &machine_chirho.io_output_chirho;
...
";
    let result_chirho =
        eval_source_with_machine_chirho(src_chirho, &mut sm_chirho, "ShareBugH.hs", None);
    match result_chirho {
        Ok((_val_chirho, machine_chirho)) => {
            let output_chirho = &machine_chirho.io_output_chirho;
            assert_eq!(output_chirho, "[1,2]\n[4]\n");
...
";
    let result_chirho =
        eval_source_with_machine_chirho(src_chirho, &mut sm_chirho, "ShareBugJ.hs", None);
    match result_chirho {
        Ok((_val_chirho, machine_chirho)) => {
            let output_chirho = &machine_chirho.io_output_chirho;
            assert_eq!(output_chirho, "3\n[4,5,6]\n");
...
";
    let result_chirho =
        eval_source_with_machine_chirho(src_chirho, &mut sm_chirho, "ShareBugI.hs", None);
    match result_chirho {
        Ok((_val_chirho, machine_chirho)) => {
            let output_chirho = &machine_chirho.io_output_chirho;
            assert_eq!(output_chirho, "3\n[4,5]\n");
...
";
    let result_chirho =
        eval_source_with_machine_chirho(src_chirho, &mut sm_chirho, "ShareBug7.hs", None);
    match result_chirho {
        Ok((_val_chirho, machine_chirho)) => {
            let output_chirho = &machine_chirho.io_output_chirho;
            assert_eq!(output_chirho, "3\n");
