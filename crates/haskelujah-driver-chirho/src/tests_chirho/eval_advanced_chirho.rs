...
use haskelujah_syntax_chirho::SourceFileChirho;
    ...
    fn eval_where_recursive_chirho() {
        ...
        match &result_chirho {
            Ok(val_chirho) => {
                assert_eq!(*val_chirho, haskelujah_runtime_chirho::ValueChirho::IntChirho(24));
            }
            Err(e_chirho) => {
...
";
        ...
        assert_eq!(result_chirho, haskelujah_runtime_chirho::ValueChirho::IntChirho(9));
    }
...
";
        ...
        assert_eq!(result_chirho, haskelujah_runtime_chirho::ValueChirho::IntChirho(10));
    }
...
";
        ...
        // 10! = 3628800
        assert_eq!(result_chirho, haskelujah_runtime_chirho::ValueChirho::IntChirho(3628800));
    }
    ...
    fn eval_overloaded_lists_identity_chirho() {
        ...
        assert_eq!(result_chirho, haskelujah_runtime_chirho::ValueChirho::IntChirho(6));
    }
    ...
    fn eval_3tuple_arithmetic_chirho() {
        ...
        assert_eq!(result_chirho, haskelujah_runtime_chirho::ValueChirho::IntChirho(60));
    }
    ...
    fn eval_strict_apply_chirho() {
        ...
        assert_eq!(result_chirho, haskelujah_runtime_chirho::ValueChirho::IntChirho(14));
    }
    ...
    fn eval_deepseq_list_chirho() {
        ...
        let result_chirho = eval_source_chirho(src_chirho, &mut sm_chirho, "Test.hs", None)
            .expect("deepseq list");
        assert_eq!(result_chirho, haskelujah_runtime_chirho::ValueChirho::IntChirho(99));
    }
    ...
    fn eval_repl_style_expression_chirho() {
        ...
        assert_eq!(result_chirho, haskelujah_runtime_chirho::ValueChirho::IntChirho(55));
    }
