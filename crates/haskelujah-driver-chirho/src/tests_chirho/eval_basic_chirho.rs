...
";
    ...
    assert_eq!(
        result_chirho.1.io_output_chirho, "x = 42\n",
...
";
    ...
    match result_chirho {
        Ok((_, machine_chirho)) => {
            assert_eq!(
                machine_chirho.io_output_chirho, "4.0\n",
...
";
    ...
    match result_chirho {
        Ok((_, machine_chirho)) => {
            assert_eq!(
                machine_chirho.io_output_chirho, "1.5\n",
...
";
    ...
    match result_chirho {
        Ok((_, machine_chirho)) => {
            assert_eq!(
                machine_chirho.io_output_chirho, "equal\n",
...
";
    ...
    match result_chirho {
        Ok((_, machine_chirho)) => {
            assert_eq!(
                machine_chirho.io_output_chirho, "not equal\n",
                "[1.0, 2.0] == [1.0, 3.0] should be False"
            );
        }
        Err(e_chirho) => {
...
";
    ...
    match result_chirho {
        Ok((_, machine_chirho)) => {
            assert_eq!(
                machine_chirho.io_output_chirho, "[1.5,2.5]\n",
                "show [1.5, 2.5] should produce [1.5,2.5]"
            );
        }
        Err(e_chirho) => {
...
";
    ...
    match result_chirho {
        Ok((_, machine_chirho)) => {
            assert_eq!(
                machine_chirho.io_output_chirho, "[True,False,True]\n",
...
main = let x = 5 in let y = 10 in x + y\n";
    ...
    match &result_chirho {
        ...
        Err(e_chirho) => panic!(
            "let-in with multiple bindings should evaluate: {}",
            e_chirho
        ),
    }
}
...
";
    ...
    match &result_chirho {
        ...
        Err(e_chirho) => panic!(
            "scoped type variables (where) should evaluate: {}",
            e_chirho
        ),
    }
}
...
";
    ...
    match &result_chirho {
        ...
        Err(e_chirho) => panic!(
            "scoped type variables (helper) should evaluate: {}",
            e_chirho
        ),
    }
}
...
";
    ...
    match &result_chirho {
        Ok(val_chirho) => {
            ...
            assert_eq!(
                *val_chirho,
                haskelujah_runtime_chirho::ValueChirho::IntChirho(87)
            );
        }
...
";
    ...
    if let haskelujah_ast_chirho::decl_chirho::DeclChirho::DataDeclChirho {
        constructors_chirho,
        ..
    } = data_decl_chirho.unwrap()
    {
        assert_eq!(constructors_chirho.len(), 2);
        assert!(
            matches!(&constructors_chirho[0], haskelujah_ast_chirho::decl_chirho::ConDeclChirho::GadtChirho { name_chirho, .. } if name_chirho.text_chirho() == "Lit")
        );
        assert!(
            matches!(&constructors_chirho[1], haskelujah_ast_chirho::decl_chirho::ConDeclChirho::GadtChirho { name_chirho, .. } if name_chirho.text_chirho() == "Add")
        );
    } else {
...
";
    ...
    assert_eq!(
        result_chirho,
        haskelujah_runtime_chirho::ValueChirho::IntChirho(200)
    );
}
...
fn eval_signum_chirho() {
    ...
    let r1_chirho = eval_source_chirho(src1_chirho, &mut source_map_chirho, "TestChirho.hs", None)
        .expect("simple + test");
    assert_eq!(
        r1_chirho,
        haskelujah_runtime_chirho::ValueChirho::IntChirho(8),
    ...
    let r2_chirho = eval_source_chirho(src2_chirho, &mut sm2_chirho, "TestChirho.hs", None)
        .expect("abs 5 test");
    assert_eq!(
        r2_chirho,
        haskelujah_runtime_chirho::ValueChirho::IntChirho(5),
    ...
    let r3_chirho = eval_source_chirho(src3_chirho, &mut sm3_chirho, "TestChirho.hs", None)
        .expect("abs 5 + 0 test");
    assert_eq!(
        r3_chirho,
        haskelujah_runtime_chirho::ValueChirho::IntChirho(5),
    ...
    let r4_chirho = eval_source_chirho(src4_chirho, &mut sm4_chirho, "TestChirho.hs", None)
        .expect("0 + abs 3 test");
    assert_eq!(
        r4_chirho,
        haskelujah_runtime_chirho::ValueChirho::IntChirho(3),
    ...
    let r5_chirho = eval_source_chirho(src5_chirho, &mut sm5_chirho, "TestChirho.hs", None)
...
fn eval_quot_rem_chirho() {
    ...
    assert_eq!(
        r3_chirho,
        haskelujah_runtime_chirho::ValueChirho::IntChirho(17)
    );
...
fn eval_power_int_chirho() {
    ...
    assert_eq!(
        r1_chirho,
        haskelujah_runtime_chirho::ValueChirho::IntChirho(1024)
    );
    ...
    assert_eq!(
        r3_chirho,
        haskelujah_runtime_chirho::ValueChirho::IntChirho(125)
    );
}
...
fn eval_power_float_chirho() {
    ...
    assert_eq!(
        r1_chirho,
        haskelujah_runtime_chirho::ValueChirho::FloatChirho(8.0)
    );
...
fn eval_num_double_sub_chirho() {
    ...
    assert_eq!(
        r_chirho,
        haskelujah_runtime_chirho::ValueChirho::FloatChirho(7.0)
    );
}
...
fn eval_num_double_mul_chirho() {
    ...
    assert_eq!(
        r_chirho,
        haskelujah_runtime_chirho::ValueChirho::FloatChirho(10.0)
    );
}
...
fn eval_num_double_negate_chirho() {
    ...
    assert_eq!(
        r1_chirho,
        haskelujah_runtime_chirho::ValueChirho::FloatChirho(-5.5)
    );
}
...
fn eval_num_double_abs_chirho() {
    ...
    assert_eq!(
        r_chirho,
        haskelujah_runtime_chirho::ValueChirho::FloatChirho(7.25)
    );
}
...
fn eval_mixed_int_float_add_chirho() {
    ...
    assert_eq!(
        r_chirho,
        haskelujah_runtime_chirho::ValueChirho::FloatChirho(3.5)
    );
}
...
fn eval_mixed_int_float_mul_chirho() {
    ...
    assert_eq!(
        r_chirho,
        haskelujah_runtime_chirho::ValueChirho::FloatChirho(6.0)
    );
}
...
fn eval_undefined_halts_chirho() {
    ...
    let msg_chirho = result_chirho.unwrap_err();
    assert!(
        msg_chirho.contains("undefined") || msg_chirho.contains("Prelude.undefined"),
...
fn eval_as_pattern_chirho() {
    ...
    match result_chirho {
        Ok(val_chirho) => {
            assert_eq!(
                val_chirho,
                haskelujah_runtime_chirho::ValueChirho::IntChirho(13)
            );
        }
...
fn eval_where_function_binding_chirho() {
    ...
    match result_chirho {
        Ok(val_chirho) => {
            ...
            assert_eq!(
                val_chirho,
                haskelujah_runtime_chirho::ValueChirho::IntChirho(32)
            );
        }
...
fn eval_when_skip_action_chirho() {
    ...
    match result_chirho {
        Ok((_val_chirho, machine_chirho)) => {
            assert_eq!(machine_chirho.io_output_chirho, "before\nafter\n")
        }
...
fn eval_unless_cond_chirho() {
    ...
    match result_chirho {
        Ok((_val_chirho, machine_chirho)) => {
            assert_eq!(machine_chirho.io_output_chirho, "executed\n")
        }
...
fn eval_show_list_bool_chirho() {
    ...
    match result_chirho {
        Ok((_val_chirho, machine_chirho)) => {
            assert_eq!(machine_chirho.io_output_chirho, "[True,False,True]\n")
        }
...
fn eval_lines_unlines_chirho() {
    ...
    match result_chirho {
        Ok((_val_chirho, machine_chirho)) => {
            assert_eq!(machine_chirho.io_output_chirho, "hello world test\n")
        }
...
fn eval_map_map_chirho() {
    ...
    match result_chirho {
        Ok(val_chirho) => assert_eq!(
            val_chirho,
            haskelujah_runtime_chirho::ValueChirho::IntChirho(40)
        ),
...
fn eval_set_from_list_chirho() {
    ...
    match result_chirho {
        ...
        Err(e_chirho) => panic!(
            "setSize (setFromList [5,3,5,1,3]) should be 3: {}",
            e_chirho
        ),
    }
}
...
fn eval_head_string_chirho() {
    ...
    match result_chirho {
        Ok(val_chirho) => assert_eq!(
            val_chirho,
            haskelujah_runtime_chirho::ValueChirho::IntChirho(104)
        ), // 'h' = 104
...
";
    ...
    match result_chirho {
        Ok(val_chirho) => assert_eq!(
            val_chirho,
            haskelujah_runtime_chirho::ValueChirho::IntChirho(50)
        ),
...
fn eval_hex_literal_chirho() {
    ...
    assert_eq!(
        val_chirho,
        haskelujah_runtime_chirho::ValueChirho::IntChirho(255)
    );
}
...
fn eval_octal_literal_chirho() {
    ...
    assert_eq!(
        val_chirho,
        haskelujah_runtime_chirho::ValueChirho::IntChirho(63)
    );
}
...
fn eval_hex_plus_octal_chirho() {
    ...
    assert_eq!(
        val_chirho,
        haskelujah_runtime_chirho::ValueChirho::IntChirho(270)
    );
}
