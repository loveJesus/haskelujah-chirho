...
";
        ...
        assert_eq!(result_chirho, haskelujah_runtime_chirho::ValueChirho::IntChirho(0));
    }
...
";
    ...
    fn eval_ord_chr_chirho() {
        ...
        assert_eq!(r1_chirho, haskelujah_runtime_chirho::ValueChirho::IntChirho(65));
        ...
        assert_eq!(r2_chirho, haskelujah_runtime_chirho::ValueChirho::IntChirho(66));
    }
    ...
    fn eval_sqrt_chirho() {
        ...
        assert_eq!(r1_chirho, haskelujah_runtime_chirho::ValueChirho::FloatChirho(2.0));
        ...
        assert_eq!(r2_chirho, haskelujah_runtime_chirho::ValueChirho::FloatChirho(3.0));
    }
...
";
        ...
        assert_eq!(r1_chirho, haskelujah_runtime_chirho::ValueChirho::IntChirho(0));
    }
    ...
    fn eval_map_maybe_chirho() {
        ...
        match result_chirho {
            Ok(val_chirho) => assert_eq!(val_chirho, haskelujah_runtime_chirho::ValueChirho::IntChirho(80)),
...
";
    ...
    fn eval_map_maybe_filter_chirho() {
        ...
        let result_chirho = eval_source_chirho(src_chirho, &mut sm_chirho, "TestChirho.hs", None);
        match result_chirho {
            Ok(val_chirho) => assert_eq!(val_chirho, haskelujah_runtime_chirho::ValueChirho::IntChirho(90)),
    ...
    fn eval_char_operations_chirho() {
        ...
        let result_chirho = eval_source_chirho(src_chirho, &mut sm_chirho, "TestChirho.hs", None);
        match result_chirho {
            Ok(val_chirho) => assert_eq!(val_chirho, haskelujah_runtime_chirho::ValueChirho::IntChirho(162)),
    ...
    fn eval_enum_succ_pred_chirho() {
        ...
        let result_chirho = eval_source_chirho(src_chirho, &mut sm_chirho, "TestChirho.hs", None);
        match result_chirho {
            Ok(val_chirho) => assert_eq!(val_chirho, haskelujah_runtime_chirho::ValueChirho::IntChirho(84)),
...
";
        let result_chirho = eval_source_chirho(src_chirho, &mut sm_chirho, "TestChirho.hs", None);
        match result_chirho {
            Ok(val_chirho) => assert_eq!(val_chirho, haskelujah_runtime_chirho::ValueChirho::IntChirho(65)),
...
";
    ...
    fn eval_3tuple_snd_chirho() {
        ...
        assert_eq!(result_chirho, haskelujah_runtime_chirho::ValueChirho::IntChirho(20));
    }
