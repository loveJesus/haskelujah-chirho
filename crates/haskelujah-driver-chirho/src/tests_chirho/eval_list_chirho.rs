...
";
    ...
    assert_eq!(
        result_chirho.1.io_output_chirho, "hello world\n",
...
fn eval_list_comp_transform_filter_chirho() {
    ...
    match result_chirho {
        Ok(val_chirho) => assert_eq!(
            val_chirho,
            haskelujah_runtime_chirho::ValueChirho::IntChirho(220)
        ),
...
fn eval_complex_list_pipeline_chirho() {
    ...
    match result_chirho {
        Ok(val_chirho) => assert_eq!(
            val_chirho,
            haskelujah_runtime_chirho::ValueChirho::IntChirho(165)
        ),
...
fn eval_sortby_sum_chirho() {
    ...
    match result_chirho {
        Ok(val_chirho) => assert_eq!(
            val_chirho,
            haskelujah_runtime_chirho::ValueChirho::IntChirho(19)
        ),
...
fn eval_zipwith3_chirho() {
    ...
    assert_eq!(
        val_chirho,
        haskelujah_runtime_chirho::ValueChirho::IntChirho(111)
    );
}
...
fn eval_take_infinite_list_then_chirho() {
    ...
    assert_eq!(
        result_chirho,
        haskelujah_runtime_chirho::ValueChirho::IntChirho(16)
    );
}
...
fn eval_zipwith_mul_chirho() {
    ...
    assert_eq!(
        result_chirho,
        haskelujah_runtime_chirho::ValueChirho::IntChirho(56)
    );
}
