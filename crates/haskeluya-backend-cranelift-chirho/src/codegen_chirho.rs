...
use haskeluya_core_chirho::expr_chirho::{BinderChirho, CoreBindingChirho, CoreExprChirho, CoreModuleChirho};
...
pub fn compile_core_to_object_chirho(
    ...
    let mut func_decl_map_chirho: HashMap<
        haskeluya_core_chirho::expr_chirho::CoreIdChirho,
...
mod tests_chirho {
    ...
    fn compile_ty_lam_app_erased_chirho() {
        use haskeluya_typing_chirho::ty_chirho::TyChirho as TyCh;
