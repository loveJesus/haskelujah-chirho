...
//!
//! JVM bytecode backend for the Rhasky compiler. Translates Core IR into
...
impl Default for JvmConfigChirho {
    fn default() -> Self {
        Self {
            ...
            package_chirho: "rhasky/generated".to_string(),
...
pub struct ClassFileChirho {
    /// Fully qualified class name (e.g. "rhasky/generated/Main").
