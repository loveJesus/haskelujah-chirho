...
use rhasky_driver_chirho::{eval_source_with_machine_chirho, run_frontend_chirho};
use rhasky_naming_chirho::builtin_module_ifaces_chirho;
use rhasky_runtime_chirho::ValueChirho;
use rhasky_span_chirho::SourceMapChirho;
use rhasky_typing_chirho::SchemeChirho;
...
pub fn repl_command_chirho() -> std::process::ExitCode {
    println!("Rhasky REPL — Haskell compiler in Rust");
