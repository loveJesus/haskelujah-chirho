...
//!
//! Provides infrastructure for comparing Haskeluya behavior against GHC
...
//! - Whether Haskeluya agrees with GHC
//!
...
pub struct DiffTestResultChirho {
    ...
    /// Haskeluya actual outcome.
    pub haskeluya_outcome_chirho: CompileOutcomeChirho,
    /// Whether Haskeluya agrees with GHC.
...
impl DiffSuiteResultChirho {
    /// Count of tests where Haskeluya agrees with GHC.
    ...
    pub fn summary_table_chirho(&self) -> String {
        ...
        lines_chirho.push(format!(
            "{:<30} {:<10} {:<20} {:<20} {:<6}",
            "Test", "Category", "GHC", "Haskeluya", "Match"
        ));
        ...
        for r_chirho in &self.results_chirho {
            lines_chirho.push(format!(
                ...
                format_outcome_chirho(&r_chirho.haskeluya_outcome_chirho),
    ...
    F: Fn(&str) -> CompileOutcomeChirho,
{
    ...
    let results_chirho: Vec<DiffTestResultChirho> = cases_chirho
        .iter()
        .map(|case_chirho| {
            let haskeluya_chirho = eval_fn_chirho(case_chirho.source_chirho);
            ...
            DiffTestResultChirho {
                ...
                haskeluya_outcome_chirho: haskeluya_chirho,
                agrees_chirho,
            }
        })
        .collect();
...
fn outcomes_agree_chirho(
    ...
    haskeluya_chirho: &CompileOutcomeChirho,
) -> bool {
    match (ghc_chirho, haskeluya_chirho) {
        ...
        let suite_chirho = DiffSuiteResultChirho {
            results_chirho: vec![
                DiffTestResultChirho {
                    ...
                    haskeluya_outcome_chirho: CompileOutcomeChirho::SuccessIntChirho(1),
                    agrees_chirho: true,
                },
                DiffTestResultChirho {
                    name_chirho: "b".into(),
                    ...
                    haskeluya_outcome_chirho: CompileOutcomeChirho::SuccessIntChirho(99),
                    agrees_chirho: false,
                },
            ],
        };
