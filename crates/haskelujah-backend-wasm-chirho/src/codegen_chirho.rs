...
fn emit_nested_if_else_chirho(
    buf_chirho: &mut Vec<u8>,
    specific_alts_chirho: &[&haskelujah_core_chirho::CoreAltChirho],
    default_alt_chirho: Option<&haskelujah_core_chirho::CoreAltChirho>,
    bind_chirho: &haskelujah_core_chirho::BinderChirho,
    ctx_chirho: &EmitCtxChirho,
    idx_chirho: usize,
) {
