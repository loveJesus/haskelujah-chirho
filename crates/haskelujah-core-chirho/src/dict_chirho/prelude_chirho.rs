...
mod demand_chirho;
mod functions_chirho;
mod io_refs_chirho;
mod maybe_transformer_chirho;
...
impl DictPassCtxChirho {
    pub fn generate_prelude_bindings_chirho(&mut self) {
        ...
        self.generate_demand_prelude_chirho();
        self.generate_function_prelude_chirho();
        ...
        // (_:xs) !! n          = xs !! (n - 1)
        {
            let elem_ty_chirho = TyChirho::VarChirho(TyVarChirho(7504));
            let list_ty_chirho = TyChirho::ListChirho(Box::new(elem_ty_chirho.clone()));
            let index_id_chirho = self.resolve_or_fresh_id_chirho("!!");
            let xs_chirho = self.fresh_binder_chirho("xs", list_ty_chirho.clone());
            let n_chirho = self.fresh_binder_chirho("n", TyChirho::int_chirho());
            let x_chirho = self.fresh_binder_chirho("x", elem_ty_chirho.clone());
            let rest_chirho = self.fresh_binder_chirho("rest", list_ty_chirho.clone());
            let nil_wild_chirho = self.fresh_binder_chirho("$nil", list_ty_chirho.clone());
            let cond_wild_chirho = self.fresh_binder_chirho("$cond", TyChirho::bool_chirho());

            let n_minus_one_chirho = CoreExprChirho::PrimOpChirho {
                name_chirho: "-#".to_string(),
                args_chirho: vec![
                    CoreExprChirho::VarChirho(n_chirho.id_chirho),
                    CoreExprChirho::LitChirho(CoreLitChirho::IntChirho(1)),
            ...
            let recursive_call_chirho = CoreExprChirho::AppChirho {
                fun_chirho: Box::new(CoreExprChirho::AppChirho {
                    fun_chirho: Box::new(CoreExprChirho::VarChirho(index_id_chirho)),
                    arg_chirho: Box::new(CoreExprChirho::VarChirho(rest_chirho.id_chirho)),
                }),
                arg_chirho: Box::new(n_minus_one_chirho),
            };
            let cons_case_chirho = CoreExprChirho::CaseChirho {
                scrutinee_chirho: Box::new(CoreExprChirho::PrimOpChirho {
                    name_chirho: "<=#".to_string(),
                    args_chirho: vec![
                        CoreExprChirho::VarChirho(n_chirho.id_chirho),
                ...
                bind_chirho: cond_wild_chirho,
                result_ty_chirho: elem_ty_chirho.clone(),
                alts_chirho: vec![
                    CoreAltChirho {
                        con_chirho: AltConChirho::DataConChirho("True".to_string()),
                        binders_chirho: vec![],
                    ...
                    CoreAltChirho {
                        con_chirho: AltConChirho::DefaultChirho,
                        binders_chirho: vec![],
                        rhs_chirho: recursive_call_chirho,
                    },
                ],
            };
            let body_chirho = CoreExprChirho::CaseChirho {
                scrutinee_chirho: Box::new(CoreExprChirho::VarChirho(xs_chirho.id_chirho)),
                bind_chirho: nil_wild_chirho,
                result_ty_chirho: elem_ty_chirho.clone(),
                alts_chirho: vec![CoreAltChirho {
                    con_chirho: AltConChirho::DataConChirho(":".to_string()),
            ...
            self.generated_bindings_chirho.push(CoreBindingChirho {
                binder_chirho: BinderChirho {
                    id_chirho: index_id_chirho,
                    name_chirho: "!!".to_string(),
                    ty_chirho: TyChirho::fun_n_chirho(
                        [list_ty_chirho, TyChirho::int_chirho()],
                        elem_ty_chirho,
                    ),
                    span_chirho: SpanChirho::DUMMY_CHIRHO,
                },
        ...
        // Integer is represented by the same runtime integer payload as Int, so
        // its Num methods can reuse the strict integer primops.
        {
            let integer_ty_chirho = TyChirho::ConChirho("Integer".to_string());

            for (method_chirho, primop_chirho) in [("+", "+#"), ("-", "-#"), ("*", "*#")] {
                let prim_name_chirho = format!("$prim_Num_{}_Integer", method_chirho);
                let prim_id_chirho = self.resolve_or_fresh_id_chirho(&prim_name_chirho);
                let a_chirho = self.fresh_binder_chirho("a", integer_ty_chirho.clone());
                let b_chirho = self.fresh_binder_chirho("b", integer_ty_chirho.clone());
                self.generated_bindings_chirho.push(CoreBindingChirho {
                    binder_chirho: BinderChirho {
            ...
            for (method_chirho, primop_chirho) in [("negate", "negate#"), ("fromInteger", "id#")] {
                let prim_name_chirho = format!("$prim_Num_{}_Integer", method_chirho);
                let prim_id_chirho = self.resolve_or_fresh_id_chirho(&prim_name_chirho);
                let n_chirho = self.fresh_binder_chirho("n", integer_ty_chirho.clone());
                let body_chirho = if primop_chirho == "id#" {
                    CoreExprChirho::VarChirho(n_chirho.id_chirho)
                } else {
            ...
            let abs_name_chirho = "$prim_Num_abs_Integer";
            let abs_id_chirho = self.resolve_or_fresh_id_chirho(abs_name_chirho);
            let n_chirho = self.fresh_binder_chirho("n", integer_ty_chirho.clone());
            let abs_wild_chirho = self.fresh_binder_chirho("$abs", TyChirho::bool_chirho());
            let abs_body_chirho = CoreExprChirho::CaseChirho {
                scrutinee_chirho: Box::new(CoreExprChirho::PrimOpChirho {
                    name_chirho: "<#".to_string(),
                    args_chirho: vec![
                        CoreExprChirho::VarChirho(n_chirho.id_chirho),
                ...
                bind_chirho: abs_wild_chirho,
                result_ty_chirho: integer_ty_chirho.clone(),
                alts_chirho: vec![
                    CoreAltChirho {
                        con_chirho: AltConChirho::DataConChirho("True".to_string()),
                        binders_chirho: vec![],
            ...
            self.generated_bindings_chirho.push(CoreBindingChirho {
                binder_chirho: BinderChirho {
                    id_chirho: abs_id_chirho,
                    name_chirho: abs_name_chirho.to_string(),
                    ty_chirho: TyChirho::fun_chirho(
                        integer_ty_chirho.clone(),
                        integer_ty_chirho.clone(),
                    ),
                ...
                rhs_chirho: CoreExprChirho::LamChirho {
                    binder_chirho: n_chirho,
                    body_chirho: Box::new(abs_body_chirho),
                },
                is_rec_chirho: false,
                inline_chirho: InlineAnnotationChirho::NoneChirho,
            });

            let signum_name_chirho = "$prim_Num_signum_Integer";
            let signum_id_chirho = self.resolve_or_fresh_id_chirho(signum_name_chirho);
            let n_chirho = self.fresh_binder_chirho("n", integer_ty_chirho.clone());
            let positive_wild_chirho =
                self.fresh_binder_chirho("$positive", TyChirho::bool_chirho());
            let negative_wild_chirho =
                self.fresh_binder_chirho("$negative", TyChirho::bool_chirho());
            let negative_case_chirho = CoreExprChirho::CaseChirho {
                scrutinee_chirho: Box::new(CoreExprChirho::PrimOpChirho {
                    name_chirho: "<#".to_string(),
                    args_chirho: vec![
                        CoreExprChirho::VarChirho(n_chirho.id_chirho),
                ...
                bind_chirho: negative_wild_chirho,
                result_ty_chirho: integer_ty_chirho.clone(),
                alts_chirho: vec![
                    CoreAltChirho {
                        con_chirho: AltConChirho::DataConChirho("True".to_string()),
            ...
            let signum_body_chirho = CoreExprChirho::CaseChirho {
                scrutinee_chirho: Box::new(CoreExprChirho::PrimOpChirho {
                    name_chirho: ">#".to_string(),
                    args_chirho: vec![
                        CoreExprChirho::VarChirho(n_chirho.id_chirho),
                ...
                bind_chirho: positive_wild_chirho,
                result_ty_chirho: integer_ty_chirho.clone(),
                alts_chirho: vec![
                    CoreAltChirho {
                        con_chirho: AltConChirho::DataConChirho("True".to_string()),
                    ...
                    CoreAltChirho {
                        con_chirho: AltConChirho::DefaultChirho,
                        binders_chirho: vec![],
                        rhs_chirho: negative_case_chirho,
                    },
                ],
            };
            self.generated_bindings_chirho.push(CoreBindingChirho {
                binder_chirho: BinderChirho {
                    ...
                    name_chirho: signum_name_chirho.to_string(),
                    ty_chirho: TyChirho::fun_chirho(integer_ty_chirho.clone(), integer_ty_chirho),
                    span_chirho: SpanChirho::DUMMY_CHIRHO,
                },
                rhs_chirho: CoreExprChirho::LamChirho {
                    binder_chirho: n_chirho,
                    body_chirho: Box::new(signum_body_chirho),
                },
                is_rec_chirho: false,
                inline_chirho: InlineAnnotationChirho::NoneChirho,
            });
    ...
    ///
    /// MaybeT operations retain the underlying m (Maybe a) action and consume
    /// the checker-proved Monad dictionary; see maybe_transformer_chirho.
    fn generate_transformer_monad_prelude_chirho(&mut self) {
        ...
        self.generate_maybe_transformer_actions_chirho();
    ...
    fn generate_functor_monad_prelude_chirho(&mut self) {
        ...
        for type_key_chirho in ["Down", "Product"] {
            ...
            {
                let prim_name_chirho = format!("$prim_Applicative_pure_{}", type_key_chirho);
                let prim_id_chirho = self.resolve_or_fresh_id_chirho(&prim_name_chirho);
                let x_chirho = self.fresh_binder_chirho("x", any_ty_chirho.clone());
                let rhs_chirho = CoreExprChirho::LamChirho {
                    binder_chirho: x_chirho.clone(),
            ...
            {
                let prim_name_chirho = format!("$prim_Applicative_<*>_{}", type_key_chirho);
                let prim_id_chirho = self.resolve_or_fresh_id_chirho(&prim_name_chirho);
                let f_chirho = self.fresh_binder_chirho("f", any_ty_chirho.clone());
                let x_chirho = self.fresh_binder_chirho("x", any_ty_chirho.clone());
                let rhs_chirho = CoreExprChirho::LamChirho {
            ...
            {
                let prim_name_chirho = format!("$prim_Monad_>>=_{}", type_key_chirho);
                let prim_id_chirho = self.resolve_or_fresh_id_chirho(&prim_name_chirho);
                let x_chirho = self.fresh_binder_chirho("x", any_ty_chirho.clone());
                let f_chirho = self.fresh_binder_chirho("f", any_ty_chirho.clone());
                let rhs_chirho = CoreExprChirho::LamChirho {
        ...
        // ── instance Functor/Applicative/Monad Proxy ──
        {
            let prim_name_chirho = "$prim_Functor_fmap_Proxy";
            let prim_id_chirho = self.resolve_or_fresh_id_chirho(prim_name_chirho);
            let f_chirho = self.fresh_binder_chirho("f", any_ty_chirho.clone());
            let x_chirho = self.fresh_binder_chirho("x", any_ty_chirho.clone());
            let rhs_chirho = CoreExprChirho::LamChirho {
        ...
        {
            let prim_name_chirho = "$prim_Applicative_pure_Proxy";
            let prim_id_chirho = self.resolve_or_fresh_id_chirho(prim_name_chirho);
            let x_chirho = self.fresh_binder_chirho("x", any_ty_chirho.clone());
            let rhs_chirho = CoreExprChirho::LamChirho {
                binder_chirho: x_chirho,
        ...
        {
            let prim_name_chirho = "$prim_Applicative_<*>_Proxy";
            let prim_id_chirho = self.resolve_or_fresh_id_chirho(prim_name_chirho);
            let f_chirho = self.fresh_binder_chirho("f", any_ty_chirho.clone());
            let x_chirho = self.fresh_binder_chirho("x", any_ty_chirho.clone());
            let rhs_chirho = CoreExprChirho::LamChirho {
        ...
        {
            let prim_name_chirho = "$prim_Monad_>>=_Proxy";
            let prim_id_chirho = self.resolve_or_fresh_id_chirho(prim_name_chirho);
            let x_chirho = self.fresh_binder_chirho("x", any_ty_chirho.clone());
            let f_chirho = self.fresh_binder_chirho("f", any_ty_chirho.clone());
            let rhs_chirho = CoreExprChirho::LamChirho {
        ...
        {
            let prim_name_chirho = "$prim_Alternative_empty_[]";
            let prim_id_chirho = self.resolve_or_fresh_id_chirho(prim_name_chirho);
            self.generated_bindings_chirho.push(CoreBindingChirho {
                binder_chirho: BinderChirho {
                    id_chirho: prim_id_chirho,
        ...
        {
            let prim_name_chirho = "$prim_Alternative_<|>_[]";
            let prim_id_chirho = self.resolve_or_fresh_id_chirho(prim_name_chirho);
            let append_id_chirho = self.resolve_or_fresh_id_chirho("append");
            let xs_chirho = self.fresh_binder_chirho("xs", any_ty_chirho.clone());
            let ys_chirho = self.fresh_binder_chirho("ys", any_ty_chirho.clone());
        ...
        {
            let prim_name_chirho = "$prim_Alternative_empty_Maybe";
            let prim_id_chirho = self.resolve_or_fresh_id_chirho(prim_name_chirho);
            self.generated_bindings_chirho.push(CoreBindingChirho {
                binder_chirho: BinderChirho {
                    id_chirho: prim_id_chirho,
        ...
        {
            let prim_name_chirho = "$prim_Alternative_<|>_Maybe";
            let prim_id_chirho = self.resolve_or_fresh_id_chirho(prim_name_chirho);
            let mx_chirho = self.fresh_binder_chirho("mx", any_ty_chirho.clone());
            let my_chirho = self.fresh_binder_chirho("my", any_ty_chirho.clone());
            let x_chirho = self.fresh_binder_chirho("x", any_ty_chirho.clone());
    ...
    fn generate_io_control_prelude_chirho(&mut self) {
        ...
        // show :: a -> String
        // Fallback for cases where dict selection cannot prove a concrete Show
        // key. showInt# delegates to universal runtime showing for mismatched
        // or heap values, matching the existing print fallback below.
        {
            let id_chirho = self.resolve_or_fresh_id_chirho("show");
            let x_chirho = self.fresh_binder_chirho("x", any_ty_chirho.clone());
            let rhs_chirho = CoreExprChirho::LamChirho {
                binder_chirho: x_chirho.clone(),
                body_chirho: Box::new(CoreExprChirho::PrimOpChirho {
    ...
    fn generate_semigroup_monoid_prelude_chirho(&mut self) {
        ...
        for (type_key_chirho, pick_first_chirho) in [("Min", true), ("Max", false)] {
            ...
            self.generated_bindings_chirho.push(CoreBindingChirho {
                binder_chirho: BinderChirho {
                    id_chirho: fn_id_chirho,
                    name_chirho: semigroup_name_chirho.clone(),
                    ty_chirho: TyChirho::fun_chirho(
                        TyChirho::int_chirho(),
                        TyChirho::fun_chirho(TyChirho::int_chirho(), TyChirho::int_chirho()),
                    ),
            ...
            let identity_chirho = if pick_first_chirho {
                i64::MAX
            } else {
                i64::MIN
            };
            ...
            self.generated_bindings_chirho.push(CoreBindingChirho {
                ...
                rhs_chirho: CoreExprChirho::LitChirho(CoreLitChirho::IntChirho(identity_chirho)),
                is_rec_chirho: false,
                inline_chirho: InlineAnnotationChirho::NoneChirho,
            });
            ...
            let mconcat_name_chirho = format!("$prim_Monoid_mconcat_{}", type_key_chirho);
            let fn_id_chirho = self.resolve_or_fresh_id_chirho(&mconcat_name_chirho);
            let semigroup_id_chirho = self.resolve_or_fresh_id_chirho(&semigroup_name_chirho);
            let xs_chirho = self
                .fresh_binder_chirho("xs", TyChirho::ListChirho(Box::new(TyChirho::int_chirho())));
            let x_chirho = self.fresh_binder_chirho("x", TyChirho::int_chirho());
            let rest_chirho = self.fresh_binder_chirho(
            ...
            let body_chirho = CoreExprChirho::CaseChirho {
                ...
                alts_chirho: vec![
                    CoreAltChirho {
                        con_chirho: AltConChirho::DataConChirho("[]".to_string()),
                        binders_chirho: vec![],
                        rhs_chirho: CoreExprChirho::LitChirho(CoreLitChirho::IntChirho(
                            identity_chirho,
                        )),
                    },
                    CoreAltChirho {
        ...
        // ── Data.Monoid.First/Last: payloads are Maybe values, not bare values ──
        let maybe_int_ty_chirho = TyChirho::AppChirho(
            Box::new(TyChirho::ConChirho("Maybe".to_string())),
            Box::new(TyChirho::int_chirho()),
        );
        for (type_key_chirho, prefer_left_chirho) in [("First", true), ("Last", false)] {
            let semigroup_name_chirho = format!("$prim_Semigroup_<>_{}", type_key_chirho);
            let fn_id_chirho = self.resolve_or_fresh_id_chirho(&semigroup_name_chirho);
            let a_chirho = self.fresh_binder_chirho("a", maybe_int_ty_chirho.clone());
            let b_chirho = self.fresh_binder_chirho("b", maybe_int_ty_chirho.clone());
            let x_chirho = self.fresh_binder_chirho("x", TyChirho::int_chirho());
            let wild_chirho = self.fresh_binder_chirho("wild", maybe_int_ty_chirho.clone());
            let (scrutinee_chirho, fallback_chirho, just_rhs_chirho) = if prefer_left_chirho {
                (
                    CoreExprChirho::VarChirho(a_chirho.id_chirho),
                    CoreExprChirho::VarChirho(b_chirho.id_chirho),
                    CoreExprChirho::ConAppChirho {
            ...
            let body_chirho = CoreExprChirho::CaseChirho {
                ...
                bind_chirho: wild_chirho,
                result_ty_chirho: maybe_int_ty_chirho.clone(),
                alts_chirho: vec![
                    CoreAltChirho {
                        con_chirho: AltConChirho::DataConChirho("Nothing".to_string()),
                        binders_chirho: vec![],
                        rhs_chirho: fallback_chirho,
                    },
                    CoreAltChirho {
                        con_chirho: AltConChirho::DataConChirho("Just".to_string()),
                        binders_chirho: vec![x_chirho],
                        rhs_chirho: just_rhs_chirho,
                    },
                ],
            };
            self.generated_bindings_chirho.push(CoreBindingChirho {
            ...
            self.generated_bindings_chirho.push(CoreBindingChirho {
                binder_chirho: BinderChirho {
                    id_chirho: fn_id_chirho,
                    name_chirho: mempty_name_chirho,
                    ty_chirho: maybe_int_ty_chirho.clone(),
                    span_chirho: SpanChirho::DUMMY_CHIRHO,
                },
                rhs_chirho: CoreExprChirho::ConAppChirho {
                    con_name_chirho: "Nothing".to_string(),
            ...
            let xs_chirho = self.fresh_binder_chirho(
                "xs",
                TyChirho::ListChirho(Box::new(maybe_int_ty_chirho.clone())),
            );
            let x_chirho = self.fresh_binder_chirho("x", maybe_int_ty_chirho.clone());
            let rest_chirho = self.fresh_binder_chirho(
                "rest",
                TyChirho::ListChirho(Box::new(maybe_int_ty_chirho.clone())),
            );
            ...
            let combine_chirho = CoreExprChirho::AppChirho {
                fun_chirho: Box::new(CoreExprChirho::AppChirho {
                    fun_chirho: Box::new(CoreExprChirho::VarChirho(
                        self.resolve_or_fresh_id_chirho(&format!(
                            "$prim_Semigroup_<>_{}",
                            type_key_chirho
                        )),
                    )),
        ...
        // ── Data.Monoid.Endo: erased to the wrapped function ──
        // Endo f <> Endo g = Endo (f . g), mempty = Endo id.
        {
            let fn_id_chirho = self.resolve_or_fresh_id_chirho("$prim_Semigroup_<>_Endo");
            let a_ty_chirho = TyChirho::VarChirho(TyVarChirho(9970));
            let endo_ty_chirho = TyChirho::fun_chirho(a_ty_chirho.clone(), a_ty_chirho.clone());
            let f_chirho = self.fresh_binder_chirho("f", endo_ty_chirho.clone());
            let g_chirho = self.fresh_binder_chirho("g", endo_ty_chirho.clone());
            let x_chirho = self.fresh_binder_chirho("x", a_ty_chirho.clone());
            let gx_chirho = CoreExprChirho::AppChirho {
                fun_chirho: Box::new(CoreExprChirho::VarChirho(g_chirho.id_chirho)),
                arg_chirho: Box::new(CoreExprChirho::VarChirho(x_chirho.id_chirho)),
            };
            let fgx_chirho = CoreExprChirho::AppChirho {
                fun_chirho: Box::new(CoreExprChirho::VarChirho(f_chirho.id_chirho)),
                arg_chirho: Box::new(gx_chirho),
            };
            let rhs_chirho = CoreExprChirho::LamChirho {
                ...
                body_chirho: Box::new(CoreExprChirho::LamChirho {
                    ...
                    body_chirho: Box::new(CoreExprChirho::LamChirho {
                        binder_chirho: x_chirho,
                        body_chirho: Box::new(fgx_chirho),
                    }),
                }),
            };
            self.generated_bindings_chirho.push(CoreBindingChirho {
                binder_chirho: BinderChirho {
                    id_chirho: fn_id_chirho,
                    name_chirho: "$prim_Semigroup_<>_Endo".to_string(),
                    ty_chirho: TyChirho::fun_chirho(
                        endo_ty_chirho.clone(),
                        TyChirho::fun_chirho(endo_ty_chirho.clone(), endo_ty_chirho.clone()),
                    ),
                    span_chirho: SpanChirho::DUMMY_CHIRHO,
                },
                rhs_chirho,
        ...
        {
            let fn_id_chirho = self.resolve_or_fresh_id_chirho("$prim_Monoid_mempty_Endo");
            let a_ty_chirho = TyChirho::VarChirho(TyVarChirho(9971));
            let x_chirho = self.fresh_binder_chirho("x", a_ty_chirho.clone());
            let endo_ty_chirho = TyChirho::fun_chirho(a_ty_chirho.clone(), a_ty_chirho);
            self.generated_bindings_chirho.push(CoreBindingChirho {
                binder_chirho: BinderChirho {
                    id_chirho: fn_id_chirho,
                    name_chirho: "$prim_Monoid_mempty_Endo".to_string(),
                    ty_chirho: endo_ty_chirho,
                    span_chirho: SpanChirho::DUMMY_CHIRHO,
                },
                rhs_chirho: CoreExprChirho::LamChirho {
                    binder_chirho: x_chirho.clone(),
        ...
        {
            let fn_id_chirho = self.resolve_or_fresh_id_chirho("$prim_Monoid_mconcat_Endo");
            let semigroup_id_chirho = self.resolve_or_fresh_id_chirho("$prim_Semigroup_<>_Endo");
            let mempty_id_chirho = self.resolve_or_fresh_id_chirho("$prim_Monoid_mempty_Endo");
            let a_ty_chirho = TyChirho::VarChirho(TyVarChirho(9972));
            let endo_ty_chirho = TyChirho::fun_chirho(a_ty_chirho.clone(), a_ty_chirho.clone());
            let list_endo_ty_chirho = TyChirho::ListChirho(Box::new(endo_ty_chirho.clone()));
            let xs_chirho = self.fresh_binder_chirho("xs", list_endo_ty_chirho.clone());
            let x_chirho = self.fresh_binder_chirho("x", endo_ty_chirho.clone());
            let rest_chirho = self.fresh_binder_chirho("rest", list_endo_ty_chirho.clone());
            let wild_chirho = self.fresh_binder_chirho("wild", list_endo_ty_chirho.clone());
            let rec_call_chirho = CoreExprChirho::AppChirho {
                fun_chirho: Box::new(CoreExprChirho::VarChirho(fn_id_chirho)),
                arg_chirho: Box::new(CoreExprChirho::VarChirho(rest_chirho.id_chirho)),
            };
            let compose_chirho = CoreExprChirho::AppChirho {
                fun_chirho: Box::new(CoreExprChirho::AppChirho {
                    fun_chirho: Box::new(CoreExprChirho::VarChirho(semigroup_id_chirho)),
                    arg_chirho: Box::new(CoreExprChirho::VarChirho(x_chirho.id_chirho)),
                }),
            ...
            let body_chirho = CoreExprChirho::CaseChirho {
                scrutinee_chirho: Box::new(CoreExprChirho::VarChirho(xs_chirho.id_chirho)),
                bind_chirho: wild_chirho,
                result_ty_chirho: endo_ty_chirho.clone(),
                alts_chirho: vec![
                    CoreAltChirho {
                        con_chirho: AltConChirho::DataConChirho("[]".to_string()),
                        binders_chirho: vec![],
                        rhs_chirho: CoreExprChirho::VarChirho(mempty_id_chirho),
                    },
                    CoreAltChirho {
                        con_chirho: AltConChirho::DataConChirho(":".to_string()),
                        binders_chirho: vec![x_chirho, rest_chirho],
                        rhs_chirho: compose_chirho,
                    },
                ],
            };
            self.generated_bindings_chirho.push(CoreBindingChirho {
                binder_chirho: BinderChirho {
                    id_chirho: fn_id_chirho,
                    name_chirho: "$prim_Monoid_mconcat_Endo".to_string(),
                    ty_chirho: TyChirho::fun_chirho(list_endo_ty_chirho, endo_ty_chirho),
                    span_chirho: SpanChirho::DUMMY_CHIRHO,
                },
                rhs_chirho: CoreExprChirho::LamChirho {
                    binder_chirho: xs_chirho,
