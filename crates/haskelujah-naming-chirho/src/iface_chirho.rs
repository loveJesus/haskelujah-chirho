...
use crate::type_exports_chirho::{
    canonical_type_name_chirho, canonical_value_name_chirho, collect_all_definitions_chirho,
    merge_all_associated_type_exports_chirho, merge_associated_type_exports_chirho,
    normalize_builtin_type_exports_chirho, remove_associated_type_exports_chirho,
    selected_associated_type_names_chirho,
};
...
pub struct IfaceExportsChirho {
    ...
    /// Associated type/data-family names grouped under their parent class.
    /// Each member also has its own entry in `types_chirho`.
    pub associated_types_chirho: HashMap<String, Vec<String>>,
}
...
fn builtin_class_methods_chirho(class_name_chirho: &str) -> Option<&'static [&'static str]> {
    match class_name_chirho {
        ...
        "IsString" => Some(&["fromString"]),
        "IsList" => Some(&["fromList", "toList"]),
        "Bits" => Some(&[
            ".&.",
            ".|.",
            "xor",
        ...
        "FiniteBits" => Some(&["finiteBitSize", "countLeadingZeros", "countTrailingZeros"]),
        "Monad" => Some(&["return", ">>=", ">>"]),
        ...
        "Contravariant" => Some(&["contramap"]),
        "Monoid" => Some(&["mempty", "mappend", "mconcat"]),
        "Semigroup" => Some(&["<>"]),
        "NFData" => Some(&["rnf"]),
        "RandomGen" => Some(&["split", "genRange", "next"]),
        "SplitGen" => Some(&["splitGen"]),
...
fn merge_imported_exports_chirho(
    ...
    match spec_chirho {
        None => {
            ...
            merge_all_associated_type_exports_chirho(result_chirho, iface_exports_chirho);
        }
...
fn merge_import_item_into_exports_chirho(
    ...
    match item_chirho {
        ...
        ImportItemChirho::TyConChirho {
            ...
            let ty_name_chirho = canonical_type_name_chirho(name_chirho.text_chirho());
            if let Some(ty_chirho) = iface_exports_chirho.types_chirho.get(&ty_name_chirho) {
                let associated_names_chirho = selected_associated_type_names_chirho(
                    iface_exports_chirho,
                    &ty_name_chirho,
                    members_chirho,
                );
        ...
        ImportItemChirho::TyConChirho {
            ...
            match members_chirho {
                ...
                ExportMembersChirho::AllChirho => {
                    ...
                    remove_associated_type_exports_chirho(
                        result_chirho,
                        &ty_name_chirho,
                        &associated_names_chirho,
                    );
...
) -> Option<(IfaceTypeChirho, Vec<IfaceValueChirho>, IfaceExportsChirho)> {
    for import_chirho in &module_chirho.imports_chirho {
        if import_chirho.qualified_chirho {
            continue;
        }
        ...
        .into_iter()
        .filter(|associated_name_chirho| {
            imported_names_chirho
                .iter()
                .any(|(name_chirho, namespace_chirho, _span_chirho)| {
                    name_chirho == associated_name_chirho
                        && *namespace_chirho == crate::env_chirho::NamespaceChirho::TypeChirho
                })
        })
        .collect::<Vec<_>>();
        let mut accompanying_associated_chirho = IfaceExportsChirho::default();
        merge_associated_type_exports_chirho(
            &mut accompanying_associated_chirho,
            &iface_chirho.exports_chirho,
            type_name_chirho,
            &associated_names_chirho,
        );
        return Some((
            ...
            accompanying_associated_chirho,
        ));
    }
    None
}
...
pub fn builtin_module_ifaces_chirho() -> Vec<ModuleIfaceChirho> {
    ...
    // GHC.CString
    {
        ...
        modules_chirho.push(ModuleIfaceChirho {
            name_chirho: "GHC.CString".to_string(),
            exports_chirho,
        });
    }
    ...
    // GHC.ByteOrder
    {
        ...
        let (k_chirho, v_chirho) = mk_type_chirho("ByteOrder", &["LittleEndian", "BigEndian"]);
        exports_chirho.types_chirho.insert(k_chirho, v_chirho);
        modules_chirho.push(ModuleIfaceChirho {
    ...
    // that the deduplication pass will merge with the first GHC.Exts.
    {
        ...
        for name_chirho in &[
            ...
            "word2Double#",
            "word2Float#",
            // Char/Addr/Float/Double comparison primops
            "eqChar#",
            "neChar#",
            "ltChar#",
            "leChar#",
    ...
    // GHC.Prim
    {
        ...
        for name_chirho in &[
            ...
            "readTVarIO#",
            "writeTVar#",
            // Comparison primops needed by word8, transformers-compat, etc.
            "isTrue#",
            "eqChar#",
            "neChar#",
            "ltChar#",
    ...
    // Language.Haskell.TH.Syntax
    {
        ...
        for (name_chirho, ctors_chirho) in [
            ...
            ("TyVarBndrUnit", &["PlainTV", "KindedTV"][..]),
            ("TyVarBndrSpec", &["PlainTV", "KindedTV"][..]),
            ("TyVarBndrVis", &["PlainTV", "KindedTV"][..]),
    ...
    // Language.Haskell.TH.Lib
    {
        ...
        for name_chirho in &[
            ...
            "tupP", "wildP", "sigP", "conT", "varT", "appT", "appKindT", "appK", "arrowT",
            "arrowK", "starK", "funD", "valD", "sigD", "clause", "normalB",
        ] {
            let (k_chirho, v_chirho) = mk_val_chirho(name_chirho);
            exports_chirho.values_chirho.insert(k_chirho, v_chirho);
        }
    ...
    // Data.ByteString.Builder
    {
        ...
        for name_chirho in &["Builder"] {
            let (k_chirho, v_chirho) = mk_type_chirho(name_chirho, &[]);
            exports_chirho.types_chirho.insert(k_chirho, v_chirho);
        }
        modules_chirho.push(ModuleIfaceChirho {
            name_chirho: "Data.ByteString.Builder".to_string(),
            exports_chirho: exports_chirho.clone(),
        });
        modules_chirho.push(ModuleIfaceChirho {
            name_chirho: "Data.ByteString.Builder.Internal".to_string(),
            exports_chirho,
        });
    }
    ...
    // GHC.Base (7 imports in GHC test suite)
    {
        ...
        exports_chirho.types_chirho.insert(k_chirho, v_chirho);
        let (k_chirho, v_chirho) = mk_type_chirho("Monoid", &["mappend", "mempty", "mconcat"]);
        exports_chirho.types_chirho.insert(k_chirho, v_chirho);
        let (k_chirho, v_chirho) = mk_type_chirho("Functor", &["fmap"]);
        exports_chirho.types_chirho.insert(k_chirho, v_chirho);
        let (k_chirho, v_chirho) = mk_type_chirho("Applicative", &["pure", "<*>"]);
    ...
    // Data.Time.Calendar.Month
    {
        ...
        let (k_chirho, v_chirho) = mk_type_chirho("Month", &[]);
        exports_chirho.types_chirho.insert(k_chirho, v_chirho);
        modules_chirho.push(ModuleIfaceChirho {
            name_chirho: "Data.Time.Calendar.Month".to_string(),
            exports_chirho,
        });
    }
    ...
    // Data.Time.Calendar.MonthDay + WeekDate
    {
        let mut exports_chirho = IfaceExportsChirho::default();
        for name_chirho in &[
        ...
        modules_chirho.push(ModuleIfaceChirho {
            name_chirho: "Data.Time.Calendar.MonthDay".to_string(),
            exports_chirho,
        });
    }
    {
        ...
        for name_chirho in &[
            ...
            "showWeekDate",
            "toWeekCalendarDate",
            "fromWeekCalendarDate",
        ] {
            let (k_chirho, v_chirho) = mk_val_chirho(name_chirho);
            exports_chirho.values_chirho.insert(k_chirho, v_chirho);
        }
        modules_chirho.push(ModuleIfaceChirho {
            name_chirho: "Data.Time.Calendar.WeekDate".to_string(),
            exports_chirho,
        });
    }
    ...
    {
        let mut exports_chirho = IfaceExportsChirho::default();
        for name_chirho in &["RawFilePath"] {
            let (k_chirho, v_chirho) = mk_type_chirho(name_chirho, &[]);
            exports_chirho.types_chirho.insert(k_chirho, v_chirho);
        }
        modules_chirho.push(ModuleIfaceChirho {
            name_chirho: "System.Posix.ByteString".to_string(),
            exports_chirho: exports_chirho.clone(),
        });
        modules_chirho.push(ModuleIfaceChirho {
            name_chirho: "System.Posix.ByteString.FilePath".to_string(),
            exports_chirho,
        });
    }
    ...
    // Control.Monad.Primitive
    {
        ...
        for name_chirho in &["PrimMonad", "PrimBase"] {
            let (k_chirho, v_chirho) = mk_type_chirho(name_chirho, &[]);
            exports_chirho.types_chirho.insert(k_chirho, v_chirho);
        }
        modules_chirho.push(ModuleIfaceChirho {
            name_chirho: "Control.Monad.Primitive".to_string(),
            exports_chirho,
        });
    }
    ...
    // Control.Monad.ST.Lazy.Safe / Control.Monad.ST.Lazy.Unsafe
    {
        ...
        exports_chirho.types_chirho.insert(k_chirho, v_chirho);
        modules_chirho.push(ModuleIfaceChirho {
            name_chirho: "Control.Monad.ST.Lazy.Safe".to_string(),
            exports_chirho: exports_chirho.clone(),
        });
        modules_chirho.push(ModuleIfaceChirho {
            name_chirho: "Control.Monad.ST.Lazy.Unsafe".to_string(),
            exports_chirho,
        });
    }
    ...
    // GHC.IOArray
    {
        ...
        let (k_chirho, v_chirho) = mk_type_chirho("IOArray", &["IOArray"]);
        exports_chirho.types_chirho.insert(k_chirho, v_chirho);
        modules_chirho.push(ModuleIfaceChirho {
            name_chirho: "GHC.IOArray".to_string(),
            exports_chirho,
        });
    }

    // Data.Generics.Aliases (from syb)
    {
        let mut exports_chirho = IfaceExportsChirho::default();
        for name_chirho in &[
            "GenericT",
        ...
        modules_chirho.push(ModuleIfaceChirho {
            name_chirho: "Data.Generics.Aliases".to_string(),
            exports_chirho,
        });
    }
    ...
    for mod_name_chirho in &[
        ...
        for name_chirho in &["DirStream", "FileStatus", "OpenFileFlags", "FdOption"] {
            let (k_chirho, v_chirho) = mk_type_chirho(name_chirho, &[]);
            exports_chirho.types_chirho.insert(k_chirho, v_chirho);
        }
        modules_chirho.push(ModuleIfaceChirho {
    ...
    }
    {
        ...
        exports_chirho.types_chirho.insert(k_chirho, v_chirho);
        modules_chirho.push(ModuleIfaceChirho {
            name_chirho: "GHC.Integer.GMP.Internals".to_string(),
            exports_chirho,
        });
    }
    ...
    {
        let mut exports_chirho = IfaceExportsChirho::default();
        let (k_chirho, v_chirho) = mk_val_chirho("utf8LengthByLeader");
        exports_chirho.values_chirho.insert(k_chirho, v_chirho);
        modules_chirho.push(ModuleIfaceChirho {
            name_chirho: "Data.Text.Internal.Encoding.Utf8".to_string(),
            exports_chirho,
        });
    }
    ...
    }
    {
        ...
        for name_chirho in &["Buffer", "BufferPool", "BufSize"] {
            let (k_chirho, v_chirho) = mk_type_chirho(name_chirho, &[]);
            exports_chirho.types_chirho.insert(k_chirho, v_chirho);
        }
        modules_chirho.push(ModuleIfaceChirho {
    ...
    let mut merged_modules_chirho = merge_module_ifaces_chirho(modules_chirho);
    normalize_builtin_type_exports_chirho(&mut merged_modules_chirho);
    merged_modules_chirho
}
...
pub fn merge_module_ifaces_chirho(
    ...
    for module_chirho in modules_chirho {
        if let Some(&idx_chirho) = index_chirho.get(&module_chirho.name_chirho) {
            ...
            for (parent_chirho, members_chirho) in
                module_chirho.exports_chirho.associated_types_chirho
            {
                let existing_members_chirho = existing_chirho
                    .exports_chirho
                    .associated_types_chirho
                    .entry(parent_chirho)
                    .or_default();
                for member_chirho in members_chirho {
                    if !existing_members_chirho.contains(&member_chirho) {
                        existing_members_chirho.push(member_chirho);
                    }
                }
            }
        } else {
    ...
    for spec_chirho in specs_chirho {
        match spec_chirho {
            ExportSpecChirho::VarChirho(name_chirho) => {
                ...
                let text_chirho = canonical_type_name_chirho(name_chirho.text_chirho());
                ...
                if let Some(ty_chirho) = all_chirho.types_chirho.get(&text_chirho) {
                    ...
                    imported_type_chirho,
                    _accompanying_values_chirho,
                    _accompanying_associated_chirho,
                    ...
                    result_chirho
                        .types_chirho
                        .insert(text_chirho, imported_type_chirho);
                }
            }
            ExportSpecChirho::TyConChirho {
                ...
                if let Some(ty_chirho) = all_chirho.types_chirho.get(&text_chirho) {
                    ...
                    result_chirho
                        .types_chirho
                        .insert(text_chirho, imported_type_chirho);
                    merge_all_associated_type_exports_chirho(
                        &mut result_chirho,
                        &accompanying_associated_chirho,
                    );
                }
            ...
            ExportSpecChirho::ModuleChirho(re_export_name_chirho) => {
                ...
                if is_self_chirho {
                    ...
                    merge_all_associated_type_exports_chirho(&mut result_chirho, all_chirho);
...
mod tests_chirho {
    ...
    use haskelujah_ast_chirho::decl_chirho::{ConDeclChirho, DeclChirho, ForeignDirectionChirho};
    ...
    #[test]
    fn export_parenthesized_operator_type_with_constructor_chirho() {
        let module_chirho = mk_module_chirho(
            "Lib",
            Some(vec![ExportSpecChirho::TyConChirho {
                name_chirho: mk_name_chirho("(:-)"),
                members_chirho: ExportMembersChirho::AllChirho,
            }]),
            vec![DeclChirho::NewtypeDeclChirho {
                ...
                constructor_chirho: ConDeclChirho::OrdinaryChirho {
                    name_chirho: mk_name_chirho("Sub"),
                    fields_chirho: vec![],
                    span_chirho: SpanChirho::DUMMY_CHIRHO,
                },
                deriving_chirho: vec![],
        ...
        let iface_chirho = build_iface_chirho(&module_chirho);
        assert!(
            iface_chirho.exports_chirho.types_chirho.contains_key(":-"),
            "parenthesized operator type export should match the operator type key"
        );
        assert!(
            iface_chirho
                .exports_chirho
                .values_chirho
                .contains_key("Sub"),
            "exporting (:-)(..) should expose the Sub constructor"
        );
        assert_eq!(
            iface_chirho.exports_chirho.types_chirho[":-"].constructors_chirho,
            vec!["Sub"]
        );
    }
    ...
    fn builtin_ghc_typelits_exports_symbol_predicates_chirho() {
        ...
        for name_chirho in ["CharToNat", "NatToChar", "<=?", "Div", "Mod", "Log2"] {
            assert!(
                ghc_typelits_chirho
                    .exports_chirho
                    .types_chirho
        ...
        let data_type_equality_chirho = ifaces_chirho
            .iter()
            .find(|iface_chirho| iface_chirho.name_chirho == "Data.Type.Equality")
            .expect("Data.Type.Equality builtin iface should exist");
        assert!(
            data_type_equality_chirho
                .exports_chirho
                .types_chirho
                .contains_key("=="),
            "Data.Type.Equality should export the == type family"
        );
    }
    ...
    #[test]
    fn builtin_ghc_exts_exports_ishiftra_hash_primop_chirho() {
        let ifaces_chirho = builtin_module_ifaces_chirho();
        let ghc_exts_chirho = ifaces_chirho
            .iter()
            .find(|iface_chirho| iface_chirho.name_chirho == "GHC.Exts")
        ...
        assert!(
            ghc_exts_chirho
                .exports_chirho
                .values_chirho
                .contains_key("iShiftRA#"),
            "GHC.Exts should export iShiftRA#"
        );
        assert!(
            ghc_exts_chirho
                .exports_chirho
                .values_chirho
                .contains_key("keepAlive#"),
            "GHC.Exts should export keepAlive#"
        );
    }
    ...
    #[test]
    fn builtin_ghc_base_exports_unsafe_chr_chirho() {
        let ifaces_chirho = builtin_module_ifaces_chirho();
    ...
    #[test]
    fn builtin_ghc_cstring_exports_unpackers_chirho() {
        let ifaces_chirho = builtin_module_ifaces_chirho();
        let ghc_cstring_chirho = ifaces_chirho
            .iter()
            .find(|iface_chirho| iface_chirho.name_chirho == "GHC.CString")
            .expect("GHC.CString builtin iface should exist");
        for name_chirho in [
            "unpackCString#",
            "unpackCStringUtf8#",
            "unpackFoldrCString#",
