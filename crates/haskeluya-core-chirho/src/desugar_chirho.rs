...
use haskeluya_typing_chirho::ty_chirho::TyChirho;
...
impl DesugarCtxChirho {
    ...
    pub fn desugar_module_chirho(&mut self, module_chirho: &ModuleChirho) -> DesugarOutputChirho {
            ...
            match decl_chirho {
                DeclChirho::FunBindChirho {
                    ...
                    let binder_chirho = self.fresh_binder_chirho(
                        ...
                        TyChirho::VarChirho(haskeluya_typing_chirho::ty_chirho::TyVarChirho(
                            self.next_id_chirho,
                        )),
                        *span_chirho,
                    );
        ...
        for decl_chirho in &module_chirho.decls_chirho {
            ...
            for con_chirho in constructors_chirho {
                if let haskeluya_ast_chirho::decl_chirho::ConDeclChirho::RecordChirho {
            ...
            match decl_chirho {
                DeclChirho::FunBindChirho {
                    ...
                    let inline_annotation_chirho = match inline_pragmas_chirho.get(&name_chirho.text_chirho().to_string()) {
                        Some(haskeluya_ast_chirho::module_chirho::InlinePragmaChirho::InlineChirho) => InlineAnnotationChirho::AlwaysChirho,
                        Some(haskeluya_ast_chirho::module_chirho::InlinePragmaChirho::NoInlineChirho) => InlineAnnotationChirho::NeverChirho,
                        Some(haskeluya_ast_chirho::module_chirho::InlinePragmaChirho::InlinableChirho) => InlineAnnotationChirho::InlinableChirho,
        ...
        for (i_chirho, wild_opt_chirho) in bang_wild_binders_chirho.iter().enumerate().rev() {
            if let Some(wild_binder_chirho) = wild_opt_chirho {
                result_chirho = CoreExprChirho::CaseChirho {
                    ...
                    result_ty_chirho: TyChirho::VarChirho(
                        haskeluya_typing_chirho::ty_chirho::TyVarChirho(0),
                    ),
                    alts_chirho: vec![CoreAltChirho {
                        con_chirho: AltConChirho::DefaultChirho,
                        binders_chirho: vec![],
    ...
    fn prebind_where_names_chirho(
        &mut self,
        where_binds_chirho: &[haskeluya_ast_chirho::expr_chirho::LocalBindChirho],
    ) -> Vec<(usize, BinderChirho)> {
        let mut pre_binders_chirho: Vec<(usize, BinderChirho)> = Vec::new();
        for (idx_chirho, bind_chirho) in where_binds_chirho.iter().enumerate() {
            match bind_chirho {
                haskeluya_ast_chirho::expr_chirho::LocalBindChirho::FunBindChirho {
                    name_chirho,
                    span_chirho,
                    ..
                } => {
                ...
                haskeluya_ast_chirho::expr_chirho::LocalBindChirho::PatBindChirho {
                    span_chirho,
                    ..
                } => {
                    let binder_chirho = self.fresh_binder_chirho(
        ...
        match expr_chirho {
            ...
            ExprChirho::LetChirho {
                ...
                for &idx_chirho in &pat_bind_indices_chirho {
                    if let haskeluya_ast_chirho::expr_chirho::LocalBindChirho::PatBindChirho {
                        pat_chirho,
                        ..
            ...
            ExprChirho::InfixChirho {
                ...
                if op_name_chirho == "$!" {
                    ...
                    return CoreExprChirho::CaseChirho {
                        ...
                        bind_chirho: wild_chirho,
                        result_ty_chirho: TyChirho::VarChirho(
                            haskeluya_typing_chirho::ty_chirho::TyVarChirho(self.next_id_chirho + 1),
                        ),
                        alts_chirho: vec![
    ...
    fn desugar_list_comp_chirho(
        ...
        quals_chirho: &[haskeluya_ast_chirho::expr_chirho::StmtChirho],
    ) -> CoreExprChirho {
        use haskeluya_ast_chirho::expr_chirho::StmtChirho;
    ...
    fn desugar_guards_chirho(
        &mut self,
        guards_chirho: &[haskeluya_ast_chirho::expr_chirho::GuardedExprChirho],
    ) -> CoreExprChirho {
        ...
        let is_otherwise_chirho = matches!(
            ...
            haskeluya_ast_chirho::expr_chirho::ExprChirho::VarChirho(n_chirho)
    ...
    fn desugar_do_chirho(
        &mut self,
        stmts_chirho: &[haskeluya_ast_chirho::expr_chirho::StmtChirho],
    ) -> CoreExprChirho {
        use haskeluya_ast_chirho::expr_chirho::StmtChirho;
...
mod tests_chirho {
    ...
    #[test]
    fn desugar_guards_chirho() {
        use haskeluya_ast_chirho::expr_chirho::GuardedExprChirho;
    ...
    fn desugar_where_binds_chirho() {
        use haskeluya_ast_chirho::expr_chirho::LocalBindChirho;
    ...
    fn desugar_record_con_chirho() {
        use haskeluya_ast_chirho::expr_chirho::FieldAssignChirho;
    ...
    fn desugar_case_con_binders_chirho() {
        ...
        let expr_chirho = ExprChirho::CaseChirho {
            ...
            alts_chirho: vec![
                haskeluya_ast_chirho::expr_chirho::AltChirho {
    ...
    fn desugar_case_tuple_binders_chirho() {
        use haskeluya_ast_chirho::expr_chirho::AltChirho as AstAltChirho;
        let mut ctx_chirho = DesugarCtxChirho::new_chirho();
        // case t of { (a, b) -> a }
        let expr_chirho = ExprChirho::CaseChirho {
    ...
    fn desugar_case_record_binders_chirho() {
        use haskeluya_ast_chirho::pat_chirho::PatFieldChirho;
        let mut ctx_chirho = DesugarCtxChirho::new_chirho();
