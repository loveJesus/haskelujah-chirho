...
use haskeluya_typing_chirho::env_chirho::TyEnvChirho;
use haskeluya_typing_chirho::ty_chirho::{SchemeChirho, TyChirho, TyVarChirho};
...
impl DictPassCtxChirho {
    ...
    fn is_defaultable_pred_chirho(
        pred_chirho: &haskeluya_typing_chirho::ty_chirho::SchemePredChirho,
...
mod tests_chirho {
    ...
    use haskeluya_typing_chirho::class_chirho::ClassEnvChirho;
    use haskeluya_typing_chirho::ty_chirho::SchemePredChirho;
    ...
    fn single_predicate_adds_dict_lambda_chirho() {
        ...
        let scheme_chirho = SchemeChirho {
            vars_chirho: vec![haskeluya_typing_chirho::ty_chirho::TyVarChirho(0)],
            ...
            ty_chirho: TyChirho::fun_chirho(
                TyChirho::VarChirho(haskeluya_typing_chirho::ty_chirho::TyVarChirho(0)),
                TyChirho::VarChirho(haskeluya_typing_chirho::ty_chirho::TyVarChirho(0)),
            ),
        };
