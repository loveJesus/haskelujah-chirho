...
use haskeluya_typing_chirho::class_chirho::ClassEnvChirho;
use haskeluya_typing_chirho::ty_chirho::{TyChirho, TyVarChirho};
...
impl DictPassCtxChirho {
    pub fn generate_prelude_bindings_chirho(&mut self) {
            ...
            (
                "id",
                {
                    let a_chirho = TyChirho::VarChirho(
                        haskeluya_typing_chirho::ty_chirho::TyVarChirho(9990),
                    );
            ...
            (
                "const",
                {
                    ...
                    let b_chirho = TyChirho::VarChirho(
                        haskeluya_typing_chirho::ty_chirho::TyVarChirho(9991),
                    );
                    TyChirho::fun_chirho(
                        a_chirho.clone(),
            ...
            (
                "flip",
                {
                    ...
                    let c_chirho = TyChirho::VarChirho(
                        haskeluya_typing_chirho::ty_chirho::TyVarChirho(9992),
                    );
                    TyChirho::fun_chirho(
                        TyChirho::fun_chirho(
                            a_chirho.clone(),
        ...
        // enumFromTo from to = if from > to then [] else from : enumFromTo (from+1) to
        {
            ...
            let body_chirho = CoreExprChirho::CaseChirho {
                ...
                result_ty_chirho: TyChirho::VarChirho(
                    haskeluya_typing_chirho::ty_chirho::TyVarChirho(9998),
                ),
                alts_chirho: vec![
                    CoreAltChirho {
                        con_chirho: AltConChirho::DataConChirho("True".to_string()),
        ...
        {
            let a_chirho = TyChirho::VarChirho(haskeluya_typing_chirho::ty_chirho::TyVarChirho(9900));
        ...
        {
            let a_chirho = TyChirho::VarChirho(haskeluya_typing_chirho::ty_chirho::TyVarChirho(9901));
            let maybe_a_chirho = TyChirho::AppChirho(
                Box::new(TyChirho::ConChirho("Maybe".to_string())),
                Box::new(a_chirho.clone()),
            );
        ...
        {
            let a_chirho = TyChirho::VarChirho(haskeluya_typing_chirho::ty_chirho::TyVarChirho(9902));
            let maybe_a_chirho = TyChirho::AppChirho(
                Box::new(TyChirho::ConChirho("Maybe".to_string())),
                Box::new(a_chirho.clone()),
            );
        ...
        {
            let a_chirho = TyChirho::VarChirho(haskeluya_typing_chirho::ty_chirho::TyVarChirho(9903));
            let b_chirho = TyChirho::VarChirho(haskeluya_typing_chirho::ty_chirho::TyVarChirho(9904));
            let maybe_a_chirho = TyChirho::AppChirho(
                Box::new(TyChirho::ConChirho("Maybe".to_string())),
                Box::new(a_chirho.clone()),
            );
        ...
        {
            let a_chirho = TyChirho::VarChirho(haskeluya_typing_chirho::ty_chirho::TyVarChirho(9905));
            let b_chirho = TyChirho::VarChirho(haskeluya_typing_chirho::ty_chirho::TyVarChirho(9906));
            let c_chirho = TyChirho::VarChirho(haskeluya_typing_chirho::ty_chirho::TyVarChirho(9907));
    ...
    fn generate_list_prelude_chirho(&mut self) {
        let a_chirho = TyChirho::VarChirho(haskeluya_typing_chirho::ty_chirho::TyVarChirho(9990));
        let b_chirho = TyChirho::VarChirho(haskeluya_typing_chirho::ty_chirho::TyVarChirho(9991));
        ...
        // zipWith :: (a -> b -> c) -> [a] -> [b] -> [c]
        {
            let c_chirho = TyChirho::VarChirho(haskeluya_typing_chirho::ty_chirho::TyVarChirho(9992));
    ...
    fn generate_transformer_prelude_chirho(&mut self) {
        use haskeluya_typing_chirho::ty_chirho::TyVarChirho;
    ...
    fn generate_ord_prelude_chirho(&mut self) {
        ...
        // replicate n x = x : replicate (n-1) x
        {
            ...
            let a_chirho = TyChirho::VarChirho(haskeluya_typing_chirho::ty_chirho::TyVarChirho(9995));
            let list_a_chirho = TyChirho::ListChirho(Box::new(a_chirho.clone()));
    ...
    fn generate_map_str_prelude_chirho(&mut self) {
        ...
        let any_v_chirho = TyChirho::VarChirho(haskeluya_typing_chirho::ty_chirho::TyVarChirho(9981));
    ...
    fn generate_set_prelude_chirho(&mut self) {
        ...
        let any_e_chirho = TyChirho::VarChirho(haskeluya_typing_chirho::ty_chirho::TyVarChirho(9985));
        let bool_ty_chirho = TyChirho::bool_chirho();
        let int_ty_chirho = TyChirho::int_chirho();
        ...
        // Implemented via foldr over setToList
        {
            ...
            let foldr_id_chirho = self.resolve_or_fresh_id_chirho("foldr");
            let to_list_id_chirho = self.resolve_or_fresh_id_chirho("setToList");
            let any_b_chirho = TyChirho::VarChirho(haskeluya_typing_chirho::ty_chirho::TyVarChirho(9986));
    ...
    fn generate_nfdata_prelude_chirho(&mut self) {
        ...
        // deepseq x y = x `seq` y
        {
            let a_chirho = TyChirho::VarChirho(haskeluya_typing_chirho::ty_chirho::TyVarChirho(3410));
            let b_chirho = TyChirho::VarChirho(haskeluya_typing_chirho::ty_chirho::TyVarChirho(3411));
        ...
        // force x = x `seq` x
        {
            let a_chirho = TyChirho::VarChirho(haskeluya_typing_chirho::ty_chirho::TyVarChirho(3412));
        ...
        {
            let a_chirho = TyChirho::VarChirho(haskeluya_typing_chirho::ty_chirho::TyVarChirho(3413));
