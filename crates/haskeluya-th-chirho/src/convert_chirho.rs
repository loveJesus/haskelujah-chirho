...
//! # TH-to-AST conversion — lowering TH splice output back to haskeluya AST
//!
...
//! module converts those TH types back into `haskeluya-ast-chirho` types so
...
use haskeluya_ast_chirho::ty_chirho::{ConstraintChirho, TypeChirho};
...
/// Convert a TH name to a haskeluya AST name.
...
/// Convert a TH type to a haskeluya AST type.
...
/// Convert a TH pattern to a haskeluya AST pattern.
...
/// Convert a TH literal to a haskeluya AST literal.
...
/// Convert a TH expression to a haskeluya AST expression.
...
/// Convert a TH match to a haskeluya case alternative.
...
/// Convert a TH body to a haskeluya RHS.
            ...
            RhsChirho::GuardedChirho(
                guards_chirho
                    ...
                    .map(|(g_chirho, e_chirho)| {
                        ...
                        haskeluya_ast_chirho::expr_chirho::GuardedExprChirho {
...
/// Convert a TH statement to a haskeluya statement.
...
/// Convert a TH declaration to a haskeluya top-level declaration.
...
/// Convert a TH constructor to a haskeluya constructor declaration.
