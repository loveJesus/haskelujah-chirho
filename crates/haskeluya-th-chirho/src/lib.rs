...
//! # Template Haskell support for Haskeluya
//!
//! This crate provides:
...
//! - Splice evaluation and conversion back to haskeluya AST
//!
//! The TH types are deliberately separate from `haskeluya-ast-chirho` types because
