...
"#;
    ...
    fn eval_condition_flag_false_chirho() {
        let mut flags_chirho = HashMap::new();
        flags_chirho.insert("debug".to_string(), false);
        let cond_chirho = ConditionChirho::FlagChirho("debug".to_string());
        assert!(!eval_condition_chirho(
            &cond_chirho,
            &flags_chirho,
...
"#;
        ...
        let expected_source_chirho = if cfg!(target_os = "windows") {
            "c-sources: cbits-win/init.c"
        ...
        assert!(
            preprocessed_chirho.contains(expected_source_chirho),
            "expected host-selected branch {expected_source_chirho}: {preprocessed_chirho}"
        );
        assert!(
            preprocessed_chirho.contains("build-depends: base"),
