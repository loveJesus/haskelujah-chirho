...
fn frontend_result_for_chirho(
    source_chirho: &str,
) -> Result<crate::FrontendResultChirho, rhasky_diagnostics_chirho::DiagnosticBundleChirho> {
    let mut source_map_chirho = SourceMapChirho::new_chirho();
...
"#;
    ...
    let frontend_chirho = match result_chirho {
        ...
        Err(diag_chirho) => {
            ...
            let file_id_chirho = source_file_chirho.file_id_chirho();
            let parser_chirho =
                rhasky_parser_chirho::cst_parser_chirho::ParserChirho::new_chirho(source_chirho, file_id_chirho);
            let green_chirho = parser_chirho.parse_chirho();
            let module_chirho = rhasky_parser_chirho::lower_chirho::lower_module_chirho(&green_chirho, file_id_chirho);
            ...
            let remaining_splices_chirho = splice_result_chirho
                ...
                .iter()
                .filter(|d_chirho| {
                    matches!(d_chirho, rhasky_ast_chirho::decl_chirho::DeclChirho::SpliceDeclChirho { .. })
                })
                .count();
            assert_eq!(
            ...
            let has_name_sig_chirho = splice_result_chirho.decls_chirho.iter().any(|d_chirho| {
                matches!(d_chirho, rhasky_ast_chirho::decl_chirho::DeclChirho::TypeSigChirho { name_chirho, .. }
                    if name_chirho.text_chirho() == "name")
            });
            let has_name_fun_chirho = splice_result_chirho.decls_chirho.iter().any(|d_chirho| {
                matches!(d_chirho, rhasky_ast_chirho::decl_chirho::DeclChirho::FunBindChirho { name_chirho, .. }
                    if name_chirho.text_chirho() == "name")
            });
    ...
    for lens_name_chirho in &["name", "age"] {
        ...
        if let Some(rhasky_ast_chirho::decl_chirho::DeclChirho::TypeSigChirho { ty_chirho, .. }) =
            sig_decl_chirho
        {
    ...
    let has_person_chirho = decls_chirho.iter().any(|d_chirho| {
        matches!(d_chirho, rhasky_ast_chirho::decl_chirho::DeclChirho::DataDeclChirho { name_chirho, .. }
...
fn type_mentions_functor_chirho(ty_chirho: &rhasky_ast_chirho::ty_chirho::TypeChirho) -> bool {
