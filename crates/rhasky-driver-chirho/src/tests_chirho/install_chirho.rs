...
";
    ...
    fn install_result_type_fields_chirho() {
        ...
        let build_plan_chirho = rhasky_package_chirho::BuildPlanChirho {
            steps_chirho: vec![],
        };
        let installed_chirho = rhasky_package_chirho::InstalledPkgChirho {
    ...
    fn pkgdb_register_after_install_chirho() {
        ...
        let installed_chirho = rhasky_package_chirho::InstalledPkgChirho {
            ...
            exposed_modules_chirho: vec![
                rhasky_package_chirho::InstalledModuleChirho {
    ...
    fn pkgdb_persistence_roundtrip_chirho() {
        ...
        for (name_chirho, ver_chirho) in &[("text", "1.2.5"), ("bytestring", "0.11.4")] {
            ...
            db_chirho.register_chirho(rhasky_package_chirho::InstalledPkgChirho {
