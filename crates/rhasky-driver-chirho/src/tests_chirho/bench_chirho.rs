...
//!
//! Runs the nofib-style benchmarks through the full Rhasky pipeline
//! and validates correctness of results.

use std::time::{Duration, Instant};

use rhasky_span_chirho::SourceMapChirho;
use rhasky_test_harness_chirho::bench_chirho::{
...
fn bench_compile_and_eval_chirho(
    ...
    let result_chirho = match val_chirho {
        rhasky_runtime_chirho::ValueChirho::IntChirho(n_chirho) => n_chirho,
