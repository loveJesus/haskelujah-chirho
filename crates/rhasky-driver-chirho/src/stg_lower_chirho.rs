...
use rhasky_runtime_chirho::{
    ArgSourceChirho, CodeChirho, ClosureChirho, DataConTagChirho, HeapAddrChirho, HeapChirho,
    MachineChirho, ValueChirho,
};
use rhasky_runtime_chirho::value_chirho::CodePtrChirho;
use rhasky_runtime_chirho::stack_chirho::PrimOpKindChirho;
...
fn collect_lam_chirho(
    expr_chirho: &CoreExprChirho,
) -> (Vec<&rhasky_core_chirho::expr_chirho::BinderChirho>, &CoreExprChirho) {
