...
#[path = "kind_chirho/phases_chirho/groups_chirho.rs"]
mod groups_chirho;
...
#[path = "kind_chirho/phases_chirho/deriving_chirho.rs"]
mod deriving_chirho;
#[path = "kind_chirho/phases_chirho/module_chirho.rs"]
mod module_chirho;
pub use module_chirho::{
    infer_module_kinds_chirho, infer_module_kinds_with_deriving_chirho,
    infer_module_kinds_with_imports_chirho,
};
