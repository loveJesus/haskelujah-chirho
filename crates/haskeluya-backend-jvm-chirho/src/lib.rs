...
//!
//! JVM bytecode backend for the Haskeluya compiler. Translates Core IR into
...
impl Default for JvmConfigChirho {
    fn default() -> Self {
        Self {
            ...
            package_chirho: "haskeluya/generated".to_string(),
...
pub struct ClassFileChirho {
    /// Fully qualified class name (e.g. "haskeluya/generated/Main").
