...
#[path = "lower_chirho/declarations_chirho/classes_chirho.rs"]
mod classes_chirho;
#[cfg(test)]
...
#[cfg(test)]
#[path = "lower_chirho/declarations_chirho/import_tests_chirho.rs"]
mod import_tests_chirho;
#[path = "lower_chirho/declarations_chirho/imports_chirho.rs"]
mod imports_chirho;
...
impl LowerCtxChirho {
            ...
            match child_chirho.element_chirho {
                GreenElementChirho::TokenChirho(tok_chirho) => {
                        ...
                        && !saw_where_chirho
                    {
                        ...
                        saw_double_colon_chirho = true;
                        let mut kind_sig_children_chirho = Vec::new();
                        ...
                        while j_chirho < children_chirho.len() {
                            ...
                            match kc_chirho.element_chirho {
                                ...
                                _ => kind_sig_children_chirho.push(kc_chirho),
                            }
                            j_chirho += 1;
                        }
    ...
    fn lower_con_decl_chirho(
        ...
        let start_idx_chirho = Self::constructor_body_start_chirho(&children_chirho);
    ...
    fn lower_gadt_con_decl_chirho(
        ...
        for child_chirho in &children_chirho {
            match child_chirho.element_chirho {
                ...
                {
                    record_fields_chirho =
                        Some(self.lower_record_fields_chirho(n_chirho, child_chirho.start_chirho));
                }
                GreenElementChirho::TokenChirho(tok_chirho) => {
                    if matches!(
                        tok_chirho.kind_chirho(),
        ...
        while idx_chirho < children_chirho.len() {
            ...
            match child_chirho.element_chirho {
                GreenElementChirho::TokenChirho(tok_chirho) => {
                    ...
                    {
                        saw_double_colon_chirho = true;
                    } else if saw_double_colon_chirho && !saw_where_chirho {
                        kind_sig_children_chirho.push(child_chirho);
                    } else if saw_newtype_chirho && !saw_equals_chirho && !saw_where_chirho {
                        let s_chirho =
                            self.span_chirho(child_chirho.start_chirho, child_chirho.end_chirho);
                        if (tok_chirho.kind_chirho() == TokenKindChirho::ConIdChirho
                            || tok_chirho.kind_chirho() == TokenKindChirho::ConSymChirho
                ...
                GreenElementChirho::NodeChirho(n_chirho) => {
                    ...
                    {
                        kind_sig_children_chirho.push(child_chirho);
                    } else if n_chirho.kind_chirho() == SyntaxKindChirho::ConDeclChirho {
                        constructor_chirho =
                            Some(self.lower_con_decl_chirho(n_chirho, child_chirho.start_chirho));
                    } else if n_chirho.kind_chirho() == SyntaxKindChirho::GadtConDeclChirho {
                        constructor_chirho = Some(
                            self.lower_gadt_con_decl_chirho(n_chirho, child_chirho.start_chirho),
                        );
                    } else if n_chirho.kind_chirho() == SyntaxKindChirho::DerivingClauseChirho {
                        deriving_chirho =
    ...
    fn lower_type_chirho(&self, node_chirho: &GreenNodeChirho, base_chirho: usize) -> TypeChirho {
        ...
        match node_chirho.kind_chirho() {
            ...
            SyntaxKindChirho::ParenTypeChirho => {
                let children_chirho = self.semantic_children_chirho(node_chirho, base_chirho);
                let inner_children_chirho: Vec<_> = children_chirho.iter().collect();
                let inner_children_chirho = match inner_children_chirho.as_slice() {
                    [first_chirho, rest_chirho @ .., last_chirho]
                        if matches!(first_chirho.element_chirho, GreenElementChirho::TokenChirho(token_chirho)
                            if token_chirho.kind_chirho() == TokenKindChirho::LeftParenChirho)
                            && matches!(last_chirho.element_chirho, GreenElementChirho::TokenChirho(token_chirho)
                            if token_chirho.kind_chirho() == TokenKindChirho::RightParenChirho) =>
                    {
                        rest_chirho
                    }
                ...
                if let Some(ascription_chirho) =
                    self.type_ascription_from_children_chirho(inner_children_chirho, span_chirho)
                {
            ...
            SyntaxKindChirho::ListTypeChirho => {
                ...
                flat_types_chirho::list_type_chirho(
                    type_node_chirho
            ...
            SyntaxKindChirho::ForallTypeChirho => {
                ...
                // `forall a. Type` and required `forall a -> Type`.
                let children_chirho = self.semantic_children_chirho(node_chirho, base_chirho);
                ...
                for child_chirho in &children_chirho {
                    match child_chirho.element_chirho {
                        GreenElementChirho::TokenChirho(tok_chirho) => {
                            let kind_chirho = tok_chirho.kind_chirho();
                            if kind_chirho == TokenKindChirho::VarIdChirho && !saw_delimiter_chirho
                            {
                                ...
                                && tok_chirho.text_chirho() == "."
                            {
                                saw_delimiter_chirho = true;
                            } else if kind_chirho == TokenKindChirho::RightArrowChirho {
                                saw_delimiter_chirho = true;
                                required_chirho = true;
                            }
                        }
                        ...
                        GreenElementChirho::NodeChirho(n_chirho)
                            if is_type_kind_chirho(n_chirho.kind_chirho()) =>
                        {
                            if body_chirho.is_none() && saw_delimiter_chirho {
                                body_chirho = Some(
                ...
                let body_chirho =
                    Box::new(body_chirho.unwrap_or_else(|| self.placeholder_type_chirho()));
                if required_chirho {
    ...
    fn lower_expr_chirho(&self, node_chirho: &GreenNodeChirho, base_chirho: usize) -> ExprChirho {
        ...
        match node_chirho.kind_chirho() {
            ...
            SyntaxKindChirho::LambdaExprChirho => {
                // workflow: language-features-chirho/rank-n-visible-type-application-chirho
                enum LambdaBinderChirho {
                    TermChirho(PatChirho),
                    TypeChirho(NameChirho),
                }
                ...
                let mut body_chirho = None;
                let mut saw_arrow_chirho = false;
                let mut has_type_binder_chirho = false;
                ...
                for child_chirho in &children_chirho {
                    match child_chirho.element_chirho {
                        ...
                        GreenElementChirho::NodeChirho(n_chirho) => {
                            if !saw_arrow_chirho
                                && n_chirho.kind_chirho()
                                    == SyntaxKindChirho::TypeLambdaBinderChirho
                            {
                                has_type_binder_chirho = true;
                                binders_chirho.push(LambdaBinderChirho::TypeChirho(
                                    self.extract_type_lambda_binder_name_chirho(
                                        n_chirho,
                                        child_chirho.start_chirho,
                                    ),
                                ));
                            ...
                            {
                                binders_chirho.push(LambdaBinderChirho::TermChirho(
                                    self.lower_pat_chirho(n_chirho, child_chirho.start_chirho),
                                ));
                            } else if !saw_arrow_chirho
                                && is_expr_kind_chirho(n_chirho.kind_chirho())
                            {
                                let pat_expr_chirho =
                                    self.lower_expr_chirho(n_chirho, child_chirho.start_chirho);
                                binders_chirho.push(LambdaBinderChirho::TermChirho(
                                    Self::expr_to_pat_chirho(&pat_expr_chirho),
                                ));
                ...
                let body_chirho = body_chirho.unwrap_or_else(|| self.placeholder_expr_chirho());
                if !has_type_binder_chirho {
                    let pats_chirho = binders_chirho
                        .into_iter()
                        .filter_map(|binder_chirho| match binder_chirho {
                            LambdaBinderChirho::TermChirho(pat_chirho) => Some(pat_chirho),
                            LambdaBinderChirho::TypeChirho(_) => None,
                        })
                        .collect();
                    ...
                    binders_chirho.into_iter().rev().fold(
                        body_chirho,
                        |body_chirho, binder_chirho| match binder_chirho {
                            LambdaBinderChirho::TermChirho(pat_chirho) => ExprChirho::LamChirho {
                                pats_chirho: vec![pat_chirho],
                                body_chirho: Box::new(body_chirho),
                                span_chirho,
                            },
                            LambdaBinderChirho::TypeChirho(binder_chirho) => {
    ...
    // workflow: language-features-chirho/rank-n-visible-type-application-chirho
    fn extract_type_lambda_binder_name_chirho(
        &self,
        node_chirho: &GreenNodeChirho,
        base_chirho: usize,
    ) -> NameChirho {
        for child_chirho in self.semantic_children_chirho(node_chirho, base_chirho) {
            match child_chirho.element_chirho {
                    ...
                    if token_chirho.kind_chirho() == TokenKindChirho::VarIdChirho =>
                {
                    let span_chirho =
                        self.span_chirho(child_chirho.start_chirho, child_chirho.end_chirho);
                    return self.name_from_token_chirho(token_chirho, span_chirho);
                }
                GreenElementChirho::NodeChirho(child_node_chirho)
                    if child_node_chirho.kind_chirho() == SyntaxKindChirho::ParenTypeChirho =>
                {
                    if let Some(type_var_chirho) = self
                        .try_lower_kind_annotated_forall_binder_chirho(
                            child_node_chirho,
                            child_chirho.start_chirho,
                        )
                    {
                        return type_var_chirho.name_chirho;
                    }
                }
                _ => {}
            }
    ...
    /// A forall binder consumes the same ascription syntax as every other type
    /// position, including nested kind annotations. Do not re-scan its CST for
    /// a direct `::` token: the parser owns that token inside KindAnnotType.
    fn try_lower_kind_annotated_forall_binder_chirho(
        &self,
        node_chirho: &GreenNodeChirho,
        base_chirho: usize,
    ) -> Option<TyVarChirho> {
        let mut type_chirho = self.lower_type_chirho(node_chirho, base_chirho);
        while let TypeChirho::ParenChirho { inner_chirho, .. } = type_chirho {
            type_chirho = *inner_chirho;
        }
        match type_chirho {
            TypeChirho::VarChirho(name_chirho) => Some(TyVarChirho::plain_chirho(name_chirho)),
            TypeChirho::KindAnnotChirho {
                ...
                Some(TyVarChirho::annotated_chirho(
                    name_chirho.clone(),
                    Self::try_type_to_ast_kind_chirho(&kind_chirho)?,
                ))
            }
            _ => None,
        }
    ...
    fn type_shape_chirho(ty_chirho: &TypeChirho) -> String {
        match ty_chirho {
            ...
            TypeChirho::KindAnnotChirho {
                ...
                "({} :: {})",
                type_shape_chirho(type_chirho),
                type_shape_chirho(kind_chirho)
            ),
            TypeChirho::QualChirho {
                context_chirho,
                body_chirho,
...
data ViewRChirho aChirho = EmptyRChirho | SeqChirho aChirho :> aChirho\n",
    ...
    #[test]
    fn lower_symbolic_minus_instance_method_with_as_pattern_lhs_chirho() {
        let module_chirho = parse_and_lower_chirho(
            "module M where\ndata GFChirho = GFChirho Int\nclass MinusLikeChirho aChirho where\n  (-) :: aChirho -> aChirho -> aChirho\ninstance MinusLikeChirho GFChirho where\n  xChirho@(GFChirho aChirho) - GFChirho bChirho = xChirho\n",
        );
        let inst_decl_chirho = module_chirho
            .decls_chirho
            .iter()
                                    ...
                                    matches!(
                                        ...
                                        PatChirho::ParenChirho { inner_chirho, .. }
                                            if matches!(
                                                inner_chirho.as_ref(),
                                                PatChirho::ConChirho { con_chirho, args_chirho, .. }
                                                    if con_chirho.text_chirho() == "GFChirho"
                                                        && args_chirho.len() == 1
                                            )
                                    ),
                                    "expected as-pattern over parenthesized constructor pattern, got {:?}",
        ...
        fn type_contains_name_chirho(ty_chirho: &TypeChirho, wanted_chirho: &str) -> bool {
            match ty_chirho {
                ...
                TypeChirho::KindAnnotChirho {
                    ...
                    type_contains_name_chirho(type_chirho, wanted_chirho)
                        || type_contains_name_chirho(kind_chirho, wanted_chirho)
                }
                TypeChirho::QualChirho {
                    context_chirho,
                    body_chirho,
    ...
    #[test]
    fn lower_type_operator_chain_stays_inside_dict_argument_chirho() {
        fn strip_forall_parens_chirho(ty_chirho: &TypeChirho) -> &TypeChirho {
            match ty_chirho {
                TypeChirho::ForallChirho { body_chirho, .. }
                | TypeChirho::ParenChirho {
                    inner_chirho: body_chirho,
                    ..
                } => strip_forall_parens_chirho(body_chirho),
                other_chirho => other_chirho,
            }
        }

        fn collect_app_spine_chirho<'a>(
            ...
            match ty_chirho {
                TypeChirho::AppChirho {
                    ...
                    collect_app_spine_chirho(fun_chirho, args_chirho)
                }
                TypeChirho::ParenChirho { inner_chirho, .. } => {
                    collect_app_spine_chirho(inner_chirho, args_chirho)
                }
                other_chirho => other_chirho,
            }
        }
        ...
        let sig_chirho = module_chirho
            ...
            .find(|decl_chirho| {
                matches!(
                    decl_chirho,
                    DeclChirho::TypeSigChirho { name_chirho, .. }
                        if name_chirho.text_chirho() == "plusDistributesOverTimes"
                )
            })
            .expect("expected plusDistributesOverTimes type signature");
        let DeclChirho::TypeSigChirho { ty_chirho, .. } = sig_chirho else {
            panic!("expected type signature");
        };
        let body_chirho = strip_forall_parens_chirho(ty_chirho);
        let mut args_chirho = Vec::new();
        let head_chirho = collect_app_spine_chirho(body_chirho, &mut args_chirho);
        args_chirho.reverse();
        assert!(
            matches!(head_chirho, TypeChirho::ConChirho(name_chirho) if name_chirho.text_chirho() == "Dict"),
            "type-operator chain should stay under Dict, got {:?}",
            body_chirho
        );
        assert_eq!(
            args_chirho.len(),
            1,
            "Dict proof should have exactly one constraint argument, got {:?}",
            body_chirho
        );
    }
    ...
    fn lower_instance_head_keeps_kind_annotated_hetero_eq_prefix_application_chirho() {
        ...
        match inst_chirho {
            DeclChirho::InstanceDeclChirho { types_chirho, .. } => {
                assert_eq!(types_chirho.len(), 1);
                assert_eq!(
                    type_shape_chirho(&types_chirho[0]),
                    "((:~~: (a :: k1)) :: (k2 -> Type))",
                    "the prefix application must keep both its argument and result classifiers"
                );
            }
            _ => unreachable!(),
        }
    ...
    fn lower_instance_tuple_type_constructor_head_chirho() {
        ...
        // The contract is tuple-constructor arity/application, not an extra
        // Paren node around the constructor's own parenthesized spelling.
        match insts_chirho[0][0].unannotated_chirho() {
            TypeChirho::ConChirho(name_chirho) => assert_eq!(name_chirho.text_chirho(), "(,)"),
            other_chirho => panic!("expected tuple constructor, got {other_chirho:?}"),
        }
        let TypeChirho::AppChirho {
            fun_chirho,
            arg_chirho,
            ..
        } = insts_chirho[1][0].unannotated_chirho()
        else {
            panic!("expected the three-tuple constructor applied to one argument");
        };
        match fun_chirho.unannotated_chirho() {
            TypeChirho::ConChirho(name_chirho) => assert_eq!(name_chirho.text_chirho(), "(,,)"),
            other_chirho => panic!("expected (,,) constructor, got {other_chirho:?}"),
        }
        match arg_chirho.unannotated_chirho() {
            TypeChirho::VarChirho(name_chirho) => assert_eq!(name_chirho.text_chirho(), "xChirho"),
            other_chirho => panic!("expected xChirho argument, got {other_chirho:?}"),
        }
    }
        ...
        match &module_chirho.decls_chirho[0] {
            DeclChirho::NewtypeDeclChirho {
                ...
                let Some(AstKindChirho::AppChirho(head_chirho, argument_chirho)) =
                    ...
                    panic!("TYPE application must survive lowering")
                };
                assert!(
                ...
                assert_eq!(
                    ...
                    &AstKindChirho::VarChirho("rChirho".into())
                );
            }
            other_chirho => panic!("expected NewtypeDecl, got {:?}", other_chirho),
        }
...
data MyList a = Nil | Cons a (MyList a)\n",
    ...
    #[test]
    fn lower_standalone_forall_kind_sig_keeps_binder_scope_chirho() {
        let module_chirho = parse_and_lower_chirho(
            "{-# LANGUAGE PolyKinds #-}\n\
{-# LANGUAGE StandaloneKindSignatures #-}\n\
module M where\n\
...
type Consed l ls = l ': ls\n",
        ...
        assert!(
            matches!(cons_head_chirho, TypeChirho::PromotedConChirho { name_chirho, .. } if name_chirho.text_chirho() == ":"),
...
type VisibleChirho fChirho aChirho = AppChirho @fChirho aChirho\n",
    ...
    #[test]
    fn lower_t17594f_preserves_rank_n_function_signature_chirho() {
        ...
        let signature_chirho = module_chirho
            ...
            .find_map(|decl_chirho| match decl_chirho {
                DeclChirho::TypeSigChirho {
                    ...
                    ty_chirho,
                    ..
                } if name_chirho.text_chirho() == "doubleOrInt" => Some(ty_chirho),
                _ => None,
            })
            .unwrap_or_else(|| {
                panic!(
                    "expected doubleOrInt type signature, got {:?}",
                    module_chirho.decls_chirho
                )
            });
        ...
        assert!(
            matches!(
                signature_chirho,
                TypeChirho::FunChirho { result_chirho, .. }
                    if matches!(result_chirho.as_ref(), TypeChirho::ForallChirho { .. })
            ),
            "expected Bool -> forall r. ... signature, got {signature_chirho:?}"
        );

        let wrap_signature_chirho = module_chirho
            .decls_chirho
            .iter()
            .find_map(|decl_chirho| match decl_chirho {
                DeclChirho::TypeSigChirho {
                    ...
                    ty_chirho,
                    ..
                } if name_chirho.text_chirho() == "wrap" => Some(ty_chirho),
                _ => None,
            })
            .expect("expected wrap type signature");
        assert!(
            matches!(
                wrap_signature_chirho,
                TypeChirho::RequiredForallChirho { vars_chirho, .. }
                    if vars_chirho.len() == 1
                        && vars_chirho[0].name_chirho.text_chirho() == "c"
            ),
            "expected required `forall c ->`, got {wrap_signature_chirho:?}"
        );

        fn contains_type_lambda_chirho(expr_chirho: &ExprChirho) -> bool {
            match expr_chirho {
                ExprChirho::TypeLamChirho { .. } => true,
                ExprChirho::AppChirho {
                    fun_chirho,
                    arg_chirho,
                    ..
                } => {
                    contains_type_lambda_chirho(fun_chirho)
                        || contains_type_lambda_chirho(arg_chirho)
                }
                ExprChirho::TypeAppChirho { expr_chirho, .. }
                | ExprChirho::ParenChirho {
                    inner_chirho: expr_chirho,
                    ..
                } => contains_type_lambda_chirho(expr_chirho),
                _ => false,
            }
        }

        let preserves_type_lambda_chirho =
            module_chirho
                .decls_chirho
                .iter()
                .any(|decl_chirho| match decl_chirho {
                    DeclChirho::FunBindChirho {
                        name_chirho,
                        matches_chirho,
                        ..
                    } if name_chirho.text_chirho() == "doubleOrInt" => {
                        matches_chirho.iter().any(|match_chirho| {
                            matches!(
                                &match_chirho.rhs_chirho,
                                RhsChirho::UnguardedChirho(expr_chirho)
                                    if contains_type_lambda_chirho(expr_chirho)
                            )
                        })
                    }
                    _ => false,
        ...
        assert!(
            preserves_type_lambda_chirho,
            "expected `\\ @a -> f` to lower as a type lambda"
        );
    }

    #[test]
    fn lower_type_abstraction_application_stays_inside_equation_chirho() {
        for (case_name_chirho, rhs_chirho) in [
            ("name_chirho", "wrapChirho"),
            ("required_arg_chirho", "wrapChirho [Num, Show]"),
            ("visible_arg_chirho", "wrapChirho [Num, Show] @Double"),
            ("term_arg_chirho", "wrapChirho [Num, Show] @Double 4.15"),
            (
                "type_lambda_chirho",
                "wrapChirho [Num, Show] @Double 4.15 \\ @valueChirho -> functionChirho",
            ),
        ] {
            let source_chirho = format!(
                "{{-# LANGUAGE TypeAbstractions #-}}\n\
module M where\n\
chooseChirho :: Bool -> forall resultChirho. (forall valueChirho. valueChirho -> resultChirho) -> resultChirho\n\
chooseChirho True functionChirho = {rhs_chirho}\n\
chooseChirho False functionChirho = functionChirho @Int 14\n"
            );
            let module_chirho = parse_and_lower_chirho(&source_chirho);

            assert!(
                module_chirho.decls_chirho.iter().any(|decl_chirho| {
                    matches!(
                        decl_chirho,
                        DeclChirho::TypeSigChirho { name_chirho, .. }
                            if name_chirho.text_chirho() == "chooseChirho"
                    )
                }),
                "{case_name_chirho} crossed the declaration boundary: {:?}",
                module_chirho.decls_chirho
            );
        }
    }
    ...
    #[test]
    fn lower_kind_annotated_type_lambda_preserves_binder_name_chirho() {
        let module_chirho = parse_and_lower_chirho(
            "{-# LANGUAGE KindSignatures #-}\n\
{-# LANGUAGE TypeAbstractions #-}\n\
module M where\n\
valueChirho = \\ @(typeChirho :: Type) -> undefined\n",
        );
        let binder_name_chirho =
            module_chirho
                .decls_chirho
                .iter()
                .find_map(|decl_chirho| match decl_chirho {
                    DeclChirho::FunBindChirho {
                        ...
                        matches_chirho,
                        ..
                    } if name_chirho.text_chirho() == "valueChirho" => matches_chirho
                        .first()
                        .and_then(|match_chirho| match &match_chirho.rhs_chirho {
                            RhsChirho::UnguardedChirho(ExprChirho::TypeLamChirho {
                                binder_chirho,
                                ..
                            }) => Some(binder_chirho.text_chirho().to_string()),
                            _ => None,
                        }),
                    _ => None,
                });

        assert_eq!(binder_name_chirho.as_deref(), Some("typeChirho"));
    }

    #[test]
    fn lower_required_forall_record_field_preserves_quantifier_chirho() {
        let module_chirho = parse_and_lower_chirho(
            "{-# LANGUAGE RequiredTypeArguments #-}\n\
module M where\n\
data HolderChirho = HolderChirho { fieldChirho :: forall typeChirho -> Proxy typeChirho }\n",
        );
        let field_type_chirho = module_chirho
            .decls_chirho
            .iter()
            .find_map(|decl_chirho| match decl_chirho {
                DeclChirho::DataDeclChirho {
                    ...
                    let ConDeclChirho::RecordChirho { fields_chirho, .. } = constructor_chirho
                    else {
                        return None;
                    };
                    fields_chirho
            ...
            .expect("expected HolderChirho record field");
        ...
        assert!(
            matches!(
                ...
                TypeChirho::RequiredForallChirho { vars_chirho, .. }
                    if vars_chirho.len() == 1
                        && vars_chirho[0].name_chirho.text_chirho() == "typeChirho"
            ),
            "expected record field required forall, got {field_type_chirho:?}"
        );
    }
...
type S @(k :: Type) (a :: k) = Proxy a -> Proxy k :: Type\n",
        ...
        assert_eq!(
            type_shape_chirho(rhs_chirho),
            "(((Proxy a) -> (Proxy k)) :: Type)",
            "RHS kind annotation must retain the full function and its written classifier: {:?}",
            rhs_chirho
        );
    }
        ...
        fn contains_l_star_head_chirho(ty_chirho: &TypeChirho) -> bool {
            ...
            match ty_chirho {
                ...
                TypeChirho::KindAnnotChirho {
                    ...
                    contains_l_star_head_chirho(type_chirho)
                        || contains_l_star_head_chirho(kind_chirho)
                }
                TypeChirho::QualChirho { body_chirho, .. }
                | TypeChirho::ForallChirho { body_chirho, .. }
                | TypeChirho::RequiredForallChirho { body_chirho, .. } => {
    ...
    fn lower_parenthesized_type_keeps_prefix_before_top_level_kind_annotation_chirho() {
        ...
        let DeclChirho::TypeAliasDeclChirho { rhs_chirho, .. } = decl_chirho else {
            unreachable!()
        };
        assert_eq!(
            type_shape_chirho(rhs_chirho),
            "((:~~: (a :: k1)) :: (k2 -> Type))",
            "the complete prefix AND both written classifiers must survive",
        );
    }
...
fn lower_qualified_do_preserves_module_qualifier_chirho() {
    ...
    assert!(module_chirho.decls_chirho.iter().any(|decl_chirho| {
        matches!(
            decl_chirho,
            DeclChirho::TypeSigChirho { name_chirho, .. }
                if name_chirho.text_chirho() == "nextChirho"
        )
    }));
    assert!(module_chirho.decls_chirho.iter().any(|decl_chirho| {
        matches!(
