...
use haskeluya_runtime_chirho::{
    ArgSourceChirho, CodeChirho, ClosureChirho, DataConTagChirho, HeapAddrChirho, HeapChirho,
    MachineChirho, ValueChirho,
};
use haskeluya_runtime_chirho::value_chirho::CodePtrChirho;
use haskeluya_runtime_chirho::stack_chirho::PrimOpKindChirho;
...
fn collect_lam_chirho(
    expr_chirho: &CoreExprChirho,
) -> (Vec<&haskeluya_core_chirho::expr_chirho::BinderChirho>, &CoreExprChirho) {
...
mod tests_chirho {
    use super::*;
    use haskeluya_core_chirho::expr_chirho::{BinderChirho, CoreBindingChirho, CoreIdChirho, InlineAnnotationChirho};
