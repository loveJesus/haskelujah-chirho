...
use haskeluya_syntax_chirho::SourceFileChirho;
    ...
    fn builds_a_check_summary_for_batch_mode_chirho() {
        ...
        assert!(
            render_summary_chirho(&check_summary_chirho).contains("llvm_preview: ; haskeluya llvm stub")
        );
    }
    ...
    fn incremental_compilation_marks_recompiled_chirho() {
        ...
        use haskeluya_incremental_chirho::IncrementalSessionChirho;
    ...
    fn cabal_project_compilation_chirho() {
        ...
        let temp_dir_chirho = std::env::temp_dir().join("haskeluya_cabal_test_chirho");
...
"#
    ...
    fn cabal_project_multi_module_chirho() {
        ...
        let temp_dir_chirho = std::env::temp_dir().join("haskeluya_cabal_multi_test_chirho");
        let _ = std::fs::remove_dir_all(&temp_dir_chirho);
        std::fs::create_dir_all(temp_dir_chirho.join("src")).unwrap();
...
"#
    ...
    fn cabal_project_missing_module_skipped_chirho() {
        ...
        let temp_dir_chirho = std::env::temp_dir().join("haskeluya_cabal_missing_test_chirho");
        let _ = std::fs::remove_dir_all(&temp_dir_chirho);
        std::fs::create_dir_all(temp_dir_chirho.join("src")).unwrap();
...
"#
    ...
    fn discover_setup_hs_chirho() {
        use haskeluya_package_chirho::PackageDescChirho;
        use std::fs;
        use tempfile::tempdir;
    ...
    fn discover_hierarchical_module_chirho() {
        use haskeluya_package_chirho::{BuildInfoChirho, LibraryChirho, PackageDescChirho};
        use std::fs;
        use tempfile::tempdir;
    ...
    fn llvm_executable_constant_chirho() {
        ...
        let exec_ir_chirho =
            haskeluya_backend_llvm_chirho::compile_core_to_llvm_executable_chirho(
                &result_chirho.core_chirho,
            );
        assert!(exec_ir_chirho.contains("define i64 @haskeluya_main()"));
        assert!(exec_ir_chirho.contains("ret i64 42"));
        assert!(exec_ir_chirho.contains("define i32 @main()"));
        assert!(exec_ir_chirho.contains("call i64 @haskeluya_main()"));
    }
    ...
    fn llvm_executable_arithmetic_chirho() {
        ...
        assert!(exec_ir_chirho.contains("call i64 @haskeluya_f(i64 10, i64 32)"));
    }
...
main = fib 10"#;
        ...
        assert!(exec_ir_chirho.contains("@haskeluya_fib"));
        assert!(exec_ir_chirho.contains("define i32 @main()"));
    }
    ...
    fn wasm_executable_constant_chirho() {
        ...
        let wasm_chirho =
            haskeluya_backend_wasm_chirho::compile_core_to_wasm_executable_chirho(
                &result_chirho.core_chirho,
            );
...
main = fib 10"#;
    ...
    fn llvm_round_trip_chirho(src_chirho: &str) -> Option<i32> {
        ...
        let exec_ir_chirho =
            haskeluya_backend_llvm_chirho::compile_core_to_llvm_executable_chirho(&result_chirho.core_chirho);
...
main = fib 10"#;
    ...
    fn cranelift_executable_constant_chirho() {
        ...
        let config_chirho = haskeluya_backend_cranelift_chirho::TargetConfigChirho::default();
        let obj_chirho =
            haskeluya_backend_cranelift_chirho::compile_core_to_object_executable_chirho(
                &result_chirho.core_chirho,
                &config_chirho,
            )
