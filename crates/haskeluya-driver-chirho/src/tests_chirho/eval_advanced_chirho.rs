...
use haskeluya_syntax_chirho::SourceFileChirho;
    ...
    fn eval_mutual_top_level_arithmetic_chirho() {
        ...
        assert_eq!(
            result_chirho.unwrap(),
            haskeluya_runtime_chirho::ValueChirho::IntChirho(8)
        );
    }
    ...
    fn eval_recursive_sum_chirho() {
        ...
        match &result_chirho {
            Ok(val_chirho) => {
                assert_eq!(*val_chirho, haskeluya_runtime_chirho::ValueChirho::IntChirho(55));
            }
            Err(e_chirho) => {
    ...
    fn eval_where_recursive_chirho() {
        ...
        match &result_chirho {
            Ok(val_chirho) => {
                assert_eq!(*val_chirho, haskeluya_runtime_chirho::ValueChirho::IntChirho(24));
            }
            Err(e_chirho) => {
...
";
    ...
    fn eval_nested_catch_chirho() {
        ...
        let val_chirho = eval_source_chirho(src_chirho, &mut sm_chirho, "TestChirho.hs", None).unwrap();
        assert_eq!(val_chirho, haskeluya_runtime_chirho::ValueChirho::IntChirho(77));
    }
...
";
        ...
        assert_eq!(result_chirho, haskeluya_runtime_chirho::ValueChirho::IntChirho(20));
    }
...
";
        ...
        assert_eq!(result_chirho, haskeluya_runtime_chirho::ValueChirho::IntChirho(9));
    }
...
";
        ...
        assert_eq!(result_chirho, haskeluya_runtime_chirho::ValueChirho::IntChirho(10));
    }
...
";
        ...
        // 10! = 3628800
        assert_eq!(result_chirho, haskeluya_runtime_chirho::ValueChirho::IntChirho(3628800));
    }
    ...
    fn eval_overloaded_lists_identity_chirho() {
        ...
        assert_eq!(result_chirho, haskeluya_runtime_chirho::ValueChirho::IntChirho(6));
    }
    ...
    fn eval_3tuple_arithmetic_chirho() {
        ...
        assert_eq!(result_chirho, haskeluya_runtime_chirho::ValueChirho::IntChirho(60));
    }
    ...
    fn eval_strict_apply_chirho() {
        ...
        assert_eq!(result_chirho, haskeluya_runtime_chirho::ValueChirho::IntChirho(14));
    }
    ...
    fn eval_deepseq_list_chirho() {
        ...
        let result_chirho = eval_source_chirho(src_chirho, &mut sm_chirho, "Test.hs", None)
            .expect("deepseq list");
        assert_eq!(result_chirho, haskeluya_runtime_chirho::ValueChirho::IntChirho(99));
    }
    ...
    fn eval_repl_style_expression_chirho() {
        ...
        assert_eq!(result_chirho, haskeluya_runtime_chirho::ValueChirho::IntChirho(55));
    }
