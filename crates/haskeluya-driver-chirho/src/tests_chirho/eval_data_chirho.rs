...
";
        ...
        match &result_chirho {
            Ok(val_chirho) => {
                assert_eq!(*val_chirho, haskeluya_runtime_chirho::ValueChirho::IntChirho(119));
            }
...
";
        let result_chirho = eval_source_chirho(src_chirho, &mut sm_chirho, "TestChirho.hs", None);
        match result_chirho {
            Ok(val_chirho) => assert_eq!(val_chirho, haskeluya_runtime_chirho::ValueChirho::IntChirho(110)),
...
";
        let result_chirho = eval_source_chirho(src_chirho, &mut sm_chirho, "TestChirho.hs", None);
        match result_chirho {
            Ok(val_chirho) => assert_eq!(val_chirho, haskeluya_runtime_chirho::ValueChirho::IntChirho(100)),
...
";
    ...
    fn eval_map_delete_size_chirho() {
        ...
        let val_chirho = eval_source_chirho(src_chirho, &mut sm_chirho, "TestChirho.hs", None).unwrap();
        assert_eq!(val_chirho, haskeluya_runtime_chirho::ValueChirho::IntChirho(2));
    }
...
";
        ...
        match result_chirho {
            Ok(val_chirho) => assert_eq!(
                val_chirho,
                haskeluya_runtime_chirho::ValueChirho::IntChirho(110),
...
"#;
        let val_chirho = eval_source_chirho(src_chirho, &mut sm_chirho, "TestChirho.hs", None).unwrap();
        assert_eq!(val_chirho, haskeluya_runtime_chirho::ValueChirho::IntChirho(17));
    }
...
"#;
        let val_chirho = eval_source_chirho(src_chirho, &mut sm_chirho, "TestChirho.hs", None).unwrap();
        assert_eq!(val_chirho, haskeluya_runtime_chirho::ValueChirho::IntChirho(33));
    }
...
";
        ...
        assert_eq!(val_chirho, haskeluya_runtime_chirho::ValueChirho::IntChirho(50));
    }
...
";
        ...
        assert_eq!(val_chirho, haskeluya_runtime_chirho::ValueChirho::IntChirho(65));
    }
    ...
    fn eval_set_filter_gt3_chirho() {
        ...
        assert_eq!(result_chirho, haskeluya_runtime_chirho::ValueChirho::IntChirho(2));
    }
