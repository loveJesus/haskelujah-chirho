...
use haskeluya_syntax_chirho::SourceFileChirho;
    ...
    fn eval_deeply_nested_pattern_chirho() {
        ...
        match &result_chirho {
            Ok(val_chirho) => assert_eq!(
                *val_chirho,
                haskeluya_runtime_chirho::ValueChirho::IntChirho(77)
            ),
            Err(e_chirho) => {
...
";
    ...
    fn eval_literal_pattern_multi_lit_chirho() {
        ...
        let result_chirho = eval_source_chirho(src_chirho, &mut sm_chirho, "TestChirho.hs", None);
        match result_chirho {
            Ok(val_chirho) => assert_eq!(val_chirho, haskeluya_runtime_chirho::ValueChirho::IntChirho(530)),
...
"#;
    ...
    fn eval_multi_equation_fib_literal_chirho() {
        ...
        match result_chirho {
            Ok(haskeluya_runtime_chirho::ValueChirho::IntChirho(55)) => {} // perfect
            Ok(val_chirho) => {
    ...
    fn eval_multi_equation_fact_literal_chirho() {
        ...
        let result_chirho = eval_source_chirho(src_chirho, &mut sm_chirho, "Main.hs", None);
        match result_chirho {
            Ok(haskeluya_runtime_chirho::ValueChirho::IntChirho(120)) => {} // perfect
            Ok(val_chirho) => {
    ...
    fn eval_multi_equation_three_literals_chirho() {
        ...
        let result_chirho = eval_source_chirho(src_chirho, &mut sm_chirho, "Main.hs", None);
        match result_chirho {
            Ok(haskeluya_runtime_chirho::ValueChirho::IntChirho(20)) => {} // perfect
            Ok(val_chirho) => {
