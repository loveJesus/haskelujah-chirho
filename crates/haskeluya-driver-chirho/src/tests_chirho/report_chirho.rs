...
//! capabilities of the Haskeluya compiler by spot-checking sections
//! marked DONE against real compilation.

use haskeluya_span_chirho::SourceMapChirho;
use haskeluya_test_harness_chirho::report_chirho::{
...
fn eval_chirho(source_chirho: &str) -> Result<i64, String> {
    ...
    match val_chirho {
        haskeluya_runtime_chirho::ValueChirho::IntChirho(n_chirho) => Ok(n_chirho),
