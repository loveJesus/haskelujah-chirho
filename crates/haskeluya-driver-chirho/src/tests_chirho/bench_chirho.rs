...
//!
//! Runs the nofib-style benchmarks through the full Haskeluya pipeline
//! and validates correctness of results.

use std::time::{Duration, Instant};

use haskeluya_span_chirho::SourceMapChirho;
use haskeluya_test_harness_chirho::bench_chirho::{
...
fn bench_compile_and_eval_chirho(
    ...
    let result_chirho = match val_chirho {
        haskeluya_runtime_chirho::ValueChirho::IntChirho(n_chirho) => n_chirho,
