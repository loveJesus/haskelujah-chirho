...
";
        ...
        assert_eq!(
            result_chirho,
            haskeluya_runtime_chirho::ValueChirho::IntChirho(9),
...
";
        ...
        assert_eq!(
            result_chirho,
            haskeluya_runtime_chirho::ValueChirho::IntChirho(40),
...
";
    ...
    fn eval_multi_gen_list_comp_chirho() {
        ...
        match result_chirho {
            Ok(val_chirho) => {
                assert_eq!(val_chirho, haskeluya_runtime_chirho::ValueChirho::IntChirho(90));
            }
    ...
    fn eval_zipwith_chirho() {
        ...
        match result_chirho {
            Ok(val_chirho) => {
                assert_eq!(val_chirho, haskeluya_runtime_chirho::ValueChirho::IntChirho(66));
            }
    ...
    fn eval_replicate_sum_chirho() {
        ...
        match result_chirho {
            Ok(val_chirho) => assert_eq!(val_chirho, haskeluya_runtime_chirho::ValueChirho::IntChirho(21)),
    ...
    fn eval_list_comp_transform_filter_chirho() {
        ...
        let result_chirho = eval_source_chirho(src_chirho, &mut sm_chirho, "TestChirho.hs", None);
        match result_chirho {
            Ok(val_chirho) => assert_eq!(val_chirho, haskeluya_runtime_chirho::ValueChirho::IntChirho(220)),
    ...
    fn eval_complex_list_pipeline_chirho() {
        ...
        let result_chirho = eval_source_chirho(src_chirho, &mut sm_chirho, "TestChirho.hs", None);
        match result_chirho {
            Ok(val_chirho) => assert_eq!(val_chirho, haskeluya_runtime_chirho::ValueChirho::IntChirho(165)),
...
";
        let result_chirho = eval_source_chirho(src_chirho, &mut sm_chirho, "TestChirho.hs", None);
        match result_chirho {
            Ok(val_chirho) => assert_eq!(val_chirho, haskeluya_runtime_chirho::ValueChirho::IntChirho(66)),
...
";
    ...
    fn eval_takewhile_sum_chirho() {
        ...
        let result_chirho = eval_source_chirho(src_chirho, &mut sm_chirho, "TestChirho.hs", None);
        match result_chirho {
            Ok(val_chirho) => assert_eq!(val_chirho, haskeluya_runtime_chirho::ValueChirho::IntChirho(10)),
    ...
    fn eval_scanl_length_chirho() {
        ...
        let result_chirho = eval_source_chirho(src_chirho, &mut sm_chirho, "TestChirho.hs", None);
        match result_chirho {
            Ok(val_chirho) => assert_eq!(val_chirho, haskeluya_runtime_chirho::ValueChirho::IntChirho(4)),
    ...
    fn eval_complex_pipeline_chirho() {
        ...
        let result_chirho = eval_source_chirho(src_chirho, &mut sm_chirho, "TestChirho.hs", None);
        match result_chirho {
            Ok(val_chirho) => assert_eq!(val_chirho, haskeluya_runtime_chirho::ValueChirho::IntChirho(24)),
    ...
    fn eval_sortby_sum_chirho() {
        ...
        let result_chirho = eval_source_chirho(src_chirho, &mut sm_chirho, "TestChirho.hs", None);
        match result_chirho {
            Ok(val_chirho) => assert_eq!(val_chirho, haskeluya_runtime_chirho::ValueChirho::IntChirho(19)),
    ...
    fn eval_repeat_take_chirho() {
        ...
        let val_chirho = eval_source_chirho(src_chirho, &mut sm_chirho, "TestChirho.hs", None).unwrap();
        assert_eq!(val_chirho, haskeluya_runtime_chirho::ValueChirho::IntChirho(35));
    }
    ...
    fn eval_fix_factorial_chirho() {
        ...
        let val_chirho = eval_source_chirho(src_chirho, &mut sm_chirho, "TestChirho.hs", None).unwrap();
        assert_eq!(val_chirho, haskeluya_runtime_chirho::ValueChirho::IntChirho(120));
    }
    ...
    fn eval_zipwith3_chirho() {
        ...
        let val_chirho = eval_source_chirho(src_chirho, &mut sm_chirho, "TestChirho.hs", None).unwrap();
        assert_eq!(val_chirho, haskeluya_runtime_chirho::ValueChirho::IntChirho(111));
    }
...
"#;
        let val_chirho = eval_source_chirho(src_chirho, &mut sm_chirho, "TestChirho.hs", None).unwrap();
        assert_eq!(val_chirho, haskeluya_runtime_chirho::ValueChirho::IntChirho(60));
    }
...
"#;
    ...
    fn eval_lazy_repeat_take_prelude_chirho() {
        ...
        assert_eq!(result_chirho, haskeluya_runtime_chirho::ValueChirho::IntChirho(35));
    }
    ...
    fn eval_lazy_iterate_take_prelude_chirho() {
        ...
        assert_eq!(result_chirho, haskeluya_runtime_chirho::ValueChirho::IntChirho(31));
    }
    ...
    fn eval_take_infinite_list_then_chirho() {
        ...
        assert_eq!(result_chirho, haskeluya_runtime_chirho::ValueChirho::IntChirho(16));
    }
    ...
    fn eval_head_infinite_list_chirho() {
        ...
        assert_eq!(result_chirho, haskeluya_runtime_chirho::ValueChirho::IntChirho(42));
    }
    ...
    fn eval_take_10_enum_from_then_chirho() {
        ...
        assert_eq!(result_chirho, haskeluya_runtime_chirho::ValueChirho::IntChirho(90));
    }
    ...
    fn eval_lazy_enum_from_then_to_chirho() {
        ...
        assert_eq!(result_chirho, haskeluya_runtime_chirho::ValueChirho::IntChirho(25));
    }
    ...
    fn eval_lazy_enum_from_then_to_desc_chirho() {
        ...
        assert_eq!(result_chirho, haskeluya_runtime_chirho::ValueChirho::IntChirho(30));
    }
...
";
    ...
    fn eval_zipwith_add_sum_chirho() {
        ...
        assert_eq!(result_chirho, haskeluya_runtime_chirho::ValueChirho::IntChirho(66));
    }
    ...
    fn eval_zipwith_mul_chirho() {
        ...
        assert_eq!(result_chirho, haskeluya_runtime_chirho::ValueChirho::IntChirho(56));
    }
