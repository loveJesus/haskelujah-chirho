...
//!
//! Build orchestration for the Haskeluya compiler. Coordinates parsing, checking,
...
use haskeluya_ast_chirho::ModuleChirho;
use haskeluya_backend_llvm_chirho::compile_to_llvm_ir_stub_chirho;
use haskeluya_backend_llvm_chirho::compile_core_to_llvm_chirho;
use haskeluya_backend_wasm_chirho::compile_to_wasm_stub_chirho;
use haskeluya_backend_wasm_chirho::compile_core_to_wasm_chirho;
use haskeluya_core_chirho::{
    desugar_module_chirho, simplify_module_chirho,
    CoreModuleChirho, SimplifyConfigChirho,
};
use haskeluya_diagnostics_chirho::{DiagnosticBundleChirho, DiagnosticChirho};
use haskeluya_naming_chirho::resolve_chirho::resolve_module_with_imports_chirho;
use haskeluya_naming_chirho::iface_chirho::{build_iface_with_imports_chirho, ModuleIfaceChirho};
use haskeluya_typing_chirho::infer_chirho::{
    InferResultChirho, infer_module_chirho, infer_module_with_imports_chirho,
};
use haskeluya_parser_chirho::cst_parser_chirho::ParserChirho;
use haskeluya_parser_chirho::lower_chirho::lower_module_chirho;
use haskeluya_runtime_chirho::{ExecutionModeChirho, RuntimePlanChirho};
...
pub fn run_frontend_chirho(
    source_chirho: &str,
    file_id_chirho: haskeluya_span_chirho::FileIdChirho,
    ifaces_chirho: &[ModuleIfaceChirho],
    imported_types_chirho: &std::collections::HashMap<String, haskeluya_typing_chirho::SchemeChirho>,
    ...
    let deriving_warnings_chirho =
        haskeluya_typing_chirho::deriving_chirho::apply_deriving_chirho(&mut module_chirho);
    ...
    let orphan_warnings_chirho =
        haskeluya_naming_chirho::check_orphan_instances_chirho(&module_chirho);

    // Phase 3.5: Kind inference
    let kind_result_chirho =
        haskeluya_typing_chirho::infer_module_kinds_chirho(&module_chirho);
    ...
    let exhaust_result_chirho =
        haskeluya_typing_chirho::check_module_exhaustiveness_chirho(&module_chirho);
...
fn inject_prelude_import_chirho(module_chirho: &mut ModuleChirho) {
    ...
    module_chirho.imports_chirho.push(haskeluya_ast_chirho::module_chirho::ImportDeclChirho {
        module_chirho: haskeluya_ast_chirho::name_chirho::NameChirho::RawChirho(
            haskeluya_ast_chirho::name_chirho::RawNameChirho::unqualified_chirho(
                "Prelude",
                haskeluya_span_chirho::SpanChirho::DUMMY_CHIRHO,
            ),
        ),
        qualified_chirho: false,
        alias_chirho: None,
        spec_chirho: None,
        span_chirho: haskeluya_span_chirho::SpanChirho::DUMMY_CHIRHO,
    });
}
...
pub fn check_source_file_chirho(
    ...
    let builtin_ifaces_chirho = haskeluya_naming_chirho::builtin_module_ifaces_chirho();
...
fn build_con_type_map_chirho(module_chirho: &ModuleChirho) -> std::collections::HashMap<String, String> {
    ...
    for decl_chirho in &module_chirho.decls_chirho {
        if let haskeluya_ast_chirho::decl_chirho::DeclChirho::DataDeclChirho {
            name_chirho,
            constructors_chirho,
            ..
        } = decl_chirho
    ...
    for decl_chirho in &module_chirho.decls_chirho {
        if let haskeluya_ast_chirho::decl_chirho::DeclChirho::NewtypeDeclChirho {
            name_chirho,
            constructor_chirho,
            ..
        } = decl_chirho
...
fn compile_backend_chirho(
    ...
    let newtype_cons_chirho: std::collections::HashSet<String> = newtype_info_chirho
        ...
        .collect();
    let dict_result_chirho = haskeluya_core_chirho::dict_pass_module_full_chirho(
...
pub fn compile_modules_chirho(
    ...
    let mut ifaces_chirho: Vec<ModuleIfaceChirho> =
        haskeluya_naming_chirho::builtin_module_ifaces_chirho();
    ...
    let mut imported_types_chirho: std::collections::HashMap<String, haskeluya_typing_chirho::SchemeChirho> =
...
pub fn eval_modules_chirho(
...
) -> Result<haskeluya_runtime_chirho::ValueChirho, String> {
    use haskeluya_core_chirho::expr_chirho::{
        CoreExprChirho,
    ...
    fn offset_binder_chirho(
        b_chirho: &mut haskeluya_core_chirho::expr_chirho::BinderChirho,
        off_chirho: u32,
    ) {
...
pub fn eval_source_with_machine_chirho(
    ...
    file_name_chirho: &str,
    entry_name_chirho: Option<&str>,
) -> Result<(haskeluya_runtime_chirho::ValueChirho, haskeluya_runtime_chirho::eval_chirho::MachineChirho), String> {
...
pub fn compile_modules_incremental_chirho(
    sources_chirho: &[(&str, &str)], // (file_name, source_text)
    source_map_chirho: &mut SourceMapChirho,
    session_chirho: &mut haskeluya_incremental_chirho::IncrementalSessionChirho,
) -> Result<Vec<(CompileResultChirho, bool)>, DiagnosticBundleChirho> {
    use haskeluya_incremental_chirho::{FingerprintChirho, PhaseTagChirho};

    // Phase 0: Register all modules and compute fingerprints.
    // Parse module headers to extract names and imports.
    let mut module_infos_chirho: Vec<(String, String, &str, haskeluya_span_chirho::FileIdChirho)> =
...
fn parse_boot_iface_chirho(
    ...
    existing_types_chirho: &std::collections::HashMap<String, haskeluya_typing_chirho::ty_chirho::SchemeChirho>,
) -> Result<(ModuleIfaceChirho, std::collections::HashMap<String, haskeluya_typing_chirho::ty_chirho::SchemeChirho>), String> {
    let source_file_chirho = SourceFileChirho::from_source_map_chirho(
        source_map_chirho,
        boot_path_chirho,
        boot_source_chirho,
...
pub fn compile_project_dir_chirho(
    ...
    let mut dep_graph_chirho = haskeluya_incremental_chirho::DepGraphChirho::new_chirho();
    ...
    for (module_name_chirho, _, source_chirho) in &module_sources_chirho {
        let fp_chirho = haskeluya_incremental_chirho::FingerprintChirho::from_str_chirho(source_chirho);
    ...
    let mut imported_types_chirho: std::collections::HashMap<
        String,
        haskeluya_typing_chirho::ty_chirho::SchemeChirho,
    > = std::collections::HashMap::new();
...
pub struct CabalCompileResultChirho {
    ...
    pub package_chirho: haskeluya_package_chirho::PackageDescChirho,
    /// The resolved build plan (external dependencies in topo order).
    pub build_plan_chirho: haskeluya_package_chirho::BuildPlanChirho,
...
pub fn compile_cabal_project_chirho(
    ...
    index_chirho: &haskeluya_package_chirho::PackageIndexChirho,
) -> Result<CabalCompileResultChirho, String> {
    use haskeluya_package_chirho::{parse_cabal_chirho, resolve_deps_chirho};
...
fn collect_package_deps_chirho(
    package_chirho: &haskeluya_package_chirho::PackageDescChirho,
) -> Vec<haskeluya_package_chirho::DependencyChirho> {
...
pub fn render_diagnostics_chirho(
    ...
    let config_chirho = if color_chirho {
        haskeluya_diagnostics_chirho::render_chirho::RenderConfigChirho::default()
    } else {
        haskeluya_diagnostics_chirho::render_chirho::RenderConfigChirho::plain_chirho()
    };
    haskeluya_diagnostics_chirho::render_chirho::render_bundle_chirho(
        diagnostics_chirho,
        source_map_chirho,
        &config_chirho,
    )
...
pub struct InstallResultChirho {
    ...
    pub installed_pkg_chirho: haskeluya_package_chirho::InstalledPkgChirho,
}
...
pub fn install_package_chirho(
    name_chirho: &str,
    version_chirho: &haskeluya_package_chirho::VersionChirho,
    install_dir_chirho: &Path,
    index_chirho: &haskeluya_package_chirho::PackageIndexChirho,
    db_chirho: &mut haskeluya_package_chirho::InstalledPkgDbChirho,
) -> Result<InstallResultChirho, String> {
    use haskeluya_package_chirho::{
    ...
    let package_chirho = haskeluya_package_chirho::parse_cabal_chirho(&cabal_content_chirho);
    ...
    let exposed_modules_chirho: Vec<haskeluya_package_chirho::InstalledModuleChirho> =
        if let Some(lib_chirho) = &package_chirho.library_chirho {
            lib_chirho
                .exposed_modules_chirho
                .iter()
                .map(|m_chirho| haskeluya_package_chirho::InstalledModuleChirho {
    ...
    let dep_tuples_chirho: Vec<(String, haskeluya_package_chirho::VersionChirho)> = all_deps_chirho
        .iter()
        .map(|d_chirho| (d_chirho.package_chirho.clone(), version_chirho.clone()))
        .collect();

    let installed_pkg_chirho = haskeluya_package_chirho::InstalledPkgChirho {
