...
use haskeluya_ast_chirho::module_chirho::{ImportDeclChirho, ImportItemChirho, ModuleChirho};
use haskeluya_ast_chirho::name_chirho::NameChirho;
use haskeluya_ast_chirho::pat_chirho::PatChirho;
use haskeluya_diagnostics_chirho::{DiagnosticBundleChirho, DiagnosticChirho, ErrorCodeChirho};
...
pub fn resolve_module_with_imports_chirho(
    ...
    for decl_chirho in &module_chirho.decls_chirho {
        match decl_chirho {
            haskeluya_ast_chirho::decl_chirho::DeclChirho::DataDeclChirho {
                name_chirho,
                constructors_chirho,
                ..
            } => {
            ...
            haskeluya_ast_chirho::decl_chirho::DeclChirho::NewtypeDeclChirho {
                name_chirho,
                constructor_chirho,
                ..
            } => {
            ...
            haskeluya_ast_chirho::decl_chirho::DeclChirho::TypeAliasDeclChirho {
                name_chirho, ..
            } => {
                bind_name_chirho(&mut env_chirho, name_chirho, NamespaceChirho::TypeChirho);
            }
            haskeluya_ast_chirho::decl_chirho::DeclChirho::ClassDeclChirho {
                name_chirho,
                methods_chirho,
                ..
            } => {
            ...
            haskeluya_ast_chirho::decl_chirho::DeclChirho::TypeFamilyDeclChirho {
                name_chirho, ..
            } => {
                bind_name_chirho(&mut env_chirho, name_chirho, NamespaceChirho::TypeChirho);
            }
    ...
    for decl_chirho in &module_chirho.decls_chirho {
        match decl_chirho {
            haskeluya_ast_chirho::decl_chirho::DeclChirho::FunBindChirho {
                name_chirho, ..
            }
            | haskeluya_ast_chirho::decl_chirho::DeclChirho::TypeSigChirho {
                name_chirho, ..
            } => {
            ...
            haskeluya_ast_chirho::decl_chirho::DeclChirho::PatBindChirho {
                pat_chirho, ..
            } => {
                // Top-level pattern binding: extract bound variable names
                bind_pat_names_chirho(&mut env_chirho, pat_chirho);
            }
            haskeluya_ast_chirho::decl_chirho::DeclChirho::InstanceDeclChirho {
                methods_chirho,
                ..
            } => {
                // Instance method implementations create value bindings
                for method_chirho in methods_chirho {
                    if let haskeluya_ast_chirho::expr_chirho::LocalBindChirho::FunBindChirho {
                        name_chirho,
                        ..
                    } = method_chirho
                    {
        ...
        let iface_chirho = match iface_chirho {
            ...
            None => {
                diagnostics_chirho.push_chirho(
                    ...
                    .with_code_chirho(ErrorCodeChirho::error_chirho(UNKNOWN_MODULE_CODE_CHIRHO))
...
fn compute_imported_names_chirho(
    ...
    spec_chirho: &Option<haskeluya_ast_chirho::module_chirho::ImportSpecChirho>,
    ...
    match item_chirho {
        ...
        ImportItemChirho::TyConChirho {
            ...
            match members_chirho {
                haskeluya_ast_chirho::module_chirho::ExportMembersChirho::AllChirho => {
                ...
                haskeluya_ast_chirho::module_chirho::ExportMembersChirho::SomeChirho(
                    member_names_chirho,
                ) => {
                ...
                haskeluya_ast_chirho::module_chirho::ExportMembersChirho::NoneChirho => {}
            }
            names_chirho
        }
    }
...
pub fn report_undefined_with_suggestions_chirho(
    ...
    use haskeluya_diagnostics_chirho::suggest_chirho::{
...
fn type_con_names_chirho(ty_chirho: &haskeluya_ast_chirho::ty_chirho::TypeChirho) -> Vec<String> {
...
pub fn check_orphan_instances_chirho(
    ...
    for decl_chirho in &module_chirho.decls_chirho {
        if let haskeluya_ast_chirho::decl_chirho::DeclChirho::InstanceDeclChirho {
            class_chirho,
            types_chirho,
            span_chirho,
            ..
...
mod tests_chirho {
    ...
    use haskeluya_ast_chirho::module_chirho::{ImportDeclChirho, ImportSpecChirho};
    use haskeluya_ast_chirho::name_chirho::RawNameChirho;
    ...
    fn resolve_class_methods_chirho() {
        let module_chirho = mk_module_chirho(
            vec![DeclChirho::ClassDeclChirho {
                ...
                methods_chirho: vec![
                    haskeluya_ast_chirho::decl_chirho::ClassMethodChirho {
                        name_chirho: dummy_name_chirho("describe"),
                        ty_chirho: haskeluya_ast_chirho::ty_chirho::TypeChirho::VarChirho(
                            dummy_name_chirho("a"),
                        ),
                        default_chirho: None,
    ...
    fn resolve_record_field_accessors_chirho() {
        use haskeluya_ast_chirho::decl_chirho::FieldDeclChirho;
    ...
    fn resolve_top_level_pat_bind_chirho() {
        use haskeluya_ast_chirho::expr_chirho::RhsChirho;
        ...
        let module_chirho = mk_module_chirho(
            vec![DeclChirho::PatBindChirho {
                ...
                rhs_chirho: RhsChirho::UnguardedChirho(
                    haskeluya_ast_chirho::expr_chirho::ExprChirho::TupleChirho {
                        elements_chirho: vec![],
                        span_chirho: SpanChirho::DUMMY_CHIRHO,
                    },
                ),
