...
use haskeluya_ast_chirho::module_chirho::{ExportMembersChirho, ExportSpecChirho, ModuleChirho};
...
pub fn builtin_module_ifaces_chirho() -> Vec<ModuleIfaceChirho> {
    ...
    // GHC.Prim
    {
        ...
        for name_chirho in &["seq", "realWorld#", "proxy#", "void#", "coerce"] {
            let (k_chirho, v_chirho) = mk_val_chirho(name_chirho);
            exports_chirho.values_chirho.insert(k_chirho, v_chirho);
        }
        modules_chirho.push(ModuleIfaceChirho {
...
mod tests_chirho {
    ...
    fn class_methods_exported_chirho() {
        let module_chirho = mk_module_chirho(
            ...
            vec![DeclChirho::ClassDeclChirho {
                ...
                type_vars_chirho: vec![],
                methods_chirho: vec![haskeluya_ast_chirho::decl_chirho::ClassMethodChirho {
                    name_chirho: mk_name_chirho("show"),
    ...
    fn module_re_export_chirho() {
        ...
        // import Inner
        // extra = 42
        use haskeluya_ast_chirho::module_chirho::ImportDeclChirho;
